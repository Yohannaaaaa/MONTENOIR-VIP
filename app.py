...
MONTENOIR_I18N_SCRIPT = r"""
<script>
(function(){
const LANGS={
tr:{
games:"🎮 OYUNLAR",tarot:"🔮 TAROT & RİTÜEL",membership:"👤 ÜYELİK / GİRİŞ",profile:"🏆 PROFİL / XP",cashier:"🪙 MONTENOIR KASASI",menu:"☰ MENU",settings:"⚙️ AYARLAR",
back:"← Ana sayfa",open:"Aç",buy:"Satın Al",join:"Katıl",accept:"Kabul Et",send:"Gönder",
menuTitle:"☰ MONTENOIR VIP MENU",menuSub:"Tüm ek sistemler tek yerde.",tournaments:"🎟️ Turnuvalar",tournamentsDesc:"Turnuvalar ve ödüller.",
custom:"🎨 Profil Özelleştirme",customDesc:"Çerçeve, renk ve profil stilleri.",chests:"🎁 Sandık Sistemi",chestsDesc:"Sandıklar ve ödüller.",
achievements:"🏆 Başarımlar",achievementsDesc:"Profil başarımları.",friends:"👥 Arkadaş Sistemi",friendsDesc:"Arkadaşlar ve özel mesajlar.",
ai:"🤖 AI Tarot Premium",aiDesc:"Premium kişisel tarot yorumu.",rules:"📜 Oyun Kuralları",rulesDesc:"Codenames, Poker, Tavla, Okey, 101, Monopoly, Ludo ve Bowling kuralları.",
settingsDesc:"Dil, tema, bildirimler ve gizlilik.",language:"🌍 Dil",theme:"🎨 Tema",notifications:"🔔 Bildirimler",privacy:"🔐 Gizlilik",help:"❓ Yardım",
rulesSimple:"Saygılı oyun, hile yasak, uygunsuz davranış yasak.",themeActive:"Siyah & altın MONTENOIR teması aktif.",notificationsSoon:"Turnuva, sandık ve özel mesaj bildirimleri yakında.",privacyText:"Email diğer oyunculara gösterilmez.",helpText:"Oyun kuralları ve destek bölümü yakında.",
chestBronze:"🥉 Bronz Sandık",chestSilver:"🥈 Gümüş Sandık",chestGold:"🥇 Altın Sandık",chestDiamond:"💎 Elmas Sandık",
goldFrame:"🟡 Altın Çerçeve",diamondFrame:"💎 Elmas Çerçeve",baroqueFrame:"🏛️ Barok Çerçeve",rainbowName:"🌈 İsim Rengi",animatedProfile:"✨ Animasyonlu Profil",
friendAdd:"Arkadaş Ekle",privateMessage:"Özel Mesaj Gönder",friendUsername:"Arkadaş kullanıcı adı",messageTarget:"Mesaj gönderilecek kullanıcı",messageText:"Mesaj",
premiumPrice:"Premium yorum: 1500 jeton",birthDate:"Doğum tarihi",question:"Sorunu yaz",photoNote:"Fotoğraf / enerji notu",premiumButton:"Premium Yorumu Al",
weeklyCodenames:"👑 Haftalık Codenames Turnuvası",entry100:"Giriş: 100 jeton",prize5000:"Ödül: 5.000 jeton",pokerTournament:"♠️ Poker Turnuvası",soon:"Yakında",
loading:"Yükleniyor...",noAchievement:"Henüz başarım yok.",friendsTitle:"Arkadaşlar",requestsTitle:"İstekler",none:"Yok"
},
fr:{
games:"🎮 JEUX",tarot:"🔮 TAROT & RITUEL",membership:"👤 ABONNEMENT / CONNEXION",profile:"🏆 PROFIL / XP",cashier:"🪙 CAISSE MONTENOIR",menu:"☰ MENU",settings:"⚙️ PARAMÈTRES",
back:"← Accueil",open:"Ouvrir",buy:"Acheter",join:"Participer",accept:"Accepter",send:"Envoyer",
menuTitle:"☰ MENU MONTENOIR VIP",menuSub:"Tous les systèmes supplémentaires au même endroit.",tournaments:"🎟️ Tournois",tournamentsDesc:"Tournois et récompenses.",
custom:"🎨 Personnalisation du profil",customDesc:"Cadres, couleurs et styles de profil.",chests:"🎁 Coffres",chestsDesc:"Coffres et récompenses.",
achievements:"🏆 Succès",achievementsDesc:"Succès du profil.",friends:"👥 Système d'amis",friendsDesc:"Amis et messages privés.",
ai:"🤖 Tarot IA Premium",aiDesc:"Interprétation personnelle premium.",rules:"📜 Règles des jeux",rulesDesc:"Règles de Codenames, Poker, Backgammon, Okey, 101, Monopoly, Ludo et Bowling.",
settingsDesc:"Langue, thème, notifications et confidentialité.",language:"🌍 Langue",theme:"🎨 Thème",notifications:"🔔 Notifications",privacy:"🔐 Confidentialité",help:"❓ Aide",
rulesSimple:"Respect obligatoire, triche interdite, comportement abusif interdit.",themeActive:"Thème noir et or MONTENOIR actif.",notificationsSoon:"Notifications de tournois, coffres et messages bientôt.",privacyText:"L’email n’est pas visible par les autres joueurs.",helpText:"Règles et assistance bientôt.",
chestBronze:"🥉 Coffre bronze",chestSilver:"🥈 Coffre argent",chestGold:"🥇 Coffre or",chestDiamond:"💎 Coffre diamant",
goldFrame:"🟡 Cadre or",diamondFrame:"💎 Cadre diamant",baroqueFrame:"🏛️ Cadre baroque",rainbowName:"🌈 Couleur du nom",animatedProfile:"✨ Profil animé",
friendAdd:"Ajouter un ami",privateMessage:"Envoyer un message privé",friendUsername:"Nom d’utilisateur de l’ami",messageTarget:"Destinataire du message",messageText:"Message",
premiumPrice:"Interprétation premium : 1500 jetons",birthDate:"Date de naissance",question:"Écris ta question",photoNote:"Photo / note énergétique",premiumButton:"Recevoir l’interprétation premium",
weeklyCodenames:"👑 Tournoi hebdomadaire Codenames",entry100:"Entrée : 100 jetons",prize5000:"Prix : 5 000 jetons",pokerTournament:"♠️ Tournoi Poker",soon:"Bientôt",
loading:"Chargement...",noAchievement:"Aucun succès pour le moment.",friendsTitle:"Amis",requestsTitle:"Demandes",none:"Aucun"
},
en:{
games:"🎮 GAMES",tarot:"🔮 TAROT & RITUAL",membership:"👤 MEMBERSHIP / LOGIN",profile:"🏆 PROFILE / XP",cashier:"🪙 MONTENOIR CASHIER",menu:"☰ MENU",settings:"⚙️ SETTINGS",
back:"← Home",open:"Open",buy:"Buy",join:"Join",accept:"Accept",send:"Send",
menuTitle:"☰ MONTENOIR VIP MENU",menuSub:"All extra systems in one place.",tournaments:"🎟️ Tournaments",tournamentsDesc:"Tournaments and rewards.",
custom:"🎨 Profile customization",customDesc:"Frames, colors and profile styles.",chests:"🎁 Chest system",chestsDesc:"Chests and rewards.",
achievements:"🏆 Achievements",achievementsDesc:"Profile achievements.",friends:"👥 Friends system",friendsDesc:"Friends and private messages.",
ai:"🤖 Premium AI Tarot",aiDesc:"Premium personal tarot reading.",rules:"📜 Game rules",rulesDesc:"Rules for Codenames, Poker, Backgammon, Okey, 101, Monopoly, Ludo and Bowling.",
settingsDesc:"Language, theme, notifications and privacy.",language:"🌍 Language",theme:"🎨 Theme",notifications:"🔔 Notifications",privacy:"🔐 Privacy",help:"❓ Help",
rulesSimple:"Respectful play, no cheating, no abusive behavior.",themeActive:"Black and gold MONTENOIR theme active.",notificationsSoon:"Tournament, chest and message notifications soon.",privacyText:"Email is not shown to other players.",helpText:"Game rules and support coming soon.",
chestBronze:"🥉 Bronze chest",chestSilver:"🥈 Silver chest",chestGold:"🥇 Gold chest",chestDiamond:"💎 Diamond chest",
goldFrame:"🟡 Gold frame",diamondFrame:"💎 Diamond frame",baroqueFrame:"🏛️ Baroque frame",rainbowName:"🌈 Name color",animatedProfile:"✨ Animated profile",
friendAdd:"Add friend",privateMessage:"Send private message",friendUsername:"Friend username",messageTarget:"Message recipient",messageText:"Message",
premiumPrice:"Premium reading: 1500 tokens",birthDate:"Birth date",question:"Write your question",photoNote:"Photo / energy note",premiumButton:"Get premium reading",
weeklyCodenames:"👑 Weekly Codenames tournament",entry100:"Entry: 100 tokens",prize5000:"Prize: 5,000 tokens",pokerTournament:"♠️ Poker tournament",soon:"Coming soon",
loading:"Loading...",noAchievement:"No achievement yet.",friendsTitle:"Friends",requestsTitle:"Requests",none:"None"
}
};
["es","de","it","pt","nl","ro","ru"].forEach(k=>{LANGS[k]=Object.assign({},LANGS.en);});
LANGS.es=Object.assign({},LANGS.en,{games:"🎮 JUEGOS",tarot:"🔮 TAROT Y RITUAL",membership:"👤 MEMBRESÍA / ENTRAR",profile:"🏆 PERFIL / XP",cashier:"🪙 CAJA MONTENOIR",settings:"⚙️ AJUSTES",back:"← Inicio",open:"Abrir",buy:"Comprar",join:"Unirse",tournaments:"🎟️ Torneos",custom:"🎨 Personalización del perfil",chests:"🎁 Cofres",achievements:"🏆 Logros",friends:"👥 Sistema de amigos",ai:"🤖 Tarot IA Premium",rules:"📜 Reglas del juego",language:"🌍 Idioma"});
LANGS.de=Object.assign({},LANGS.en,{games:"🎮 SPIELE",tarot:"🔮 TAROT & RITUAL",membership:"👤 MITGLIEDSCHAFT / LOGIN",profile:"🏆 PROFIL / XP",cashier:"🪙 MONTENOIR KASSE",settings:"⚙️ EINSTELLUNGEN",back:"← Startseite",open:"Öffnen",buy:"Kaufen",join:"Teilnehmen",tournaments:"🎟️ Turniere",custom:"🎨 Profil anpassen",chests:"🎁 Truhen",achievements:"🏆 Erfolge",friends:"👥 Freundessystem",ai:"🤖 Premium KI-Tarot",rules:"📜 Spielregeln",language:"🌍 Sprache"});
LANGS.it=Object.assign({},LANGS.en,{games:"🎮 GIOCHI",tarot:"🔮 TAROCCHI & RITUALE",membership:"👤 ABBONAMENTO / LOGIN",profile:"🏆 PROFILO / XP",cashier:"🪙 CASSA MONTENOIR",settings:"⚙️ IMPOSTAZIONI",back:"← Home",open:"Apri",buy:"Acquista",join:"Partecipa",tournaments:"🎟️ Tornei",custom:"🎨 Personalizza profilo",chests:"🎁 Forzieri",achievements:"🏆 Obiettivi",friends:"👥 Sistema amici",ai:"🤖 Tarocchi IA Premium",rules:"📜 Regole dei giochi",language:"🌍 Lingua"});
LANGS.pt=Object.assign({},LANGS.en,{games:"🎮 JOGOS",tarot:"🔮 TAROT & RITUAL",membership:"👤 ADESÃO / LOGIN",profile:"🏆 PERFIL / XP",cashier:"🪙 CAIXA MONTENOIR",settings:"⚙️ DEFINIÇÕES",back:"← Início",open:"Abrir",buy:"Comprar",join:"Participar",tournaments:"🎟️ Torneios",custom:"🎨 Personalizar perfil",chests:"🎁 Baús",achievements:"🏆 Conquistas",friends:"👥 Sistema de amigos",ai:"🤖 Tarot IA Premium",rules:"📜 Regras dos jogos",language:"🌍 Idioma"});
LANGS.nl=Object.assign({},LANGS.en,{games:"🎮 SPELLEN",tarot:"🔮 TAROT & RITUEEL",membership:"👤 LIDMAATSCHAP / LOGIN",profile:"🏆 PROFIEL / XP",cashier:"🪙 MONTENOIR KASSA",settings:"⚙️ INSTELLINGEN",back:"← Home",open:"Openen",buy:"Kopen",join:"Meedoen",tournaments:"🎟️ Toernooien",custom:"🎨 Profiel aanpassen",chests:"🎁 Kisten",achievements:"🏆 Prestaties",friends:"👥 Vriendensysteem",ai:"🤖 Premium AI Tarot",rules:"📜 Spelregels",language:"🌍 Taal"});
LANGS.ro=Object.assign({},LANGS.en,{games:"🎮 JOCURI",tarot:"🔮 TAROT & RITUAL",membership:"👤 ABONAMENT / LOGIN",profile:"🏆 PROFIL / XP",cashier:"🪙 CASIERIA MONTENOIR",settings:"⚙️ SETĂRI",back:"← Acasă",open:"Deschide",buy:"Cumpără",join:"Participă",tournaments:"🎟️ Turnee",custom:"🎨 Personalizare profil",chests:"🎁 Cufere",achievements:"🏆 Realizări",friends:"👥 Sistem prieteni",ai:"🤖 Tarot AI Premium",rules:"📜 Regulile jocurilor",language:"🌍 Limbă"});
LANGS.ru=Object.assign({},LANGS.en,{games:"🎮 ИГРЫ",tarot:"🔮 ТАРО И РИТУАЛ",membership:"👤 ПОДПИСКА / ВХОД",profile:"🏆 ПРОФИЛЬ / XP",cashier:"🪙 КАССА MONTENOIR",settings:"⚙️ НАСТРОЙКИ",back:"← Главная",open:"Открыть",buy:"Купить",join:"Участвовать",tournaments:"🎟️ Турниры",custom:"🎨 Настройка профиля",chests:"🎁 Сундуки",achievements:"🏆 Достижения",friends:"👥 Система друзей",ai:"🤖 Премиум AI Таро",rules:"📜 Правила игр",language:"🌍 Язык"});
LANGS.ar=Object.assign({},LANGS.en,{games:"🎮 الألعاب",tarot:"🔮 التاروت والطقوس",membership:"👤 العضوية / الدخول",profile:"🏆 الملف / XP",cashier:"🪙 خزينة مونتينوار",menu:"☰ القائمة",settings:"⚙️ الإعدادات",back:"← الرئيسية",open:"فتح",buy:"شراء",join:"انضمام",tournaments:"🎟️ البطولات",custom:"🎨 تخصيص الملف",chests:"🎁 الصناديق",achievements:"🏆 الإنجازات",friends:"👥 نظام الأصدقاء",ai:"🤖 تاروت AI بريميوم",rules:"📜 قواعد الألعاب",language:"🌍 اللغة"});
const BASE={
"🎮 OYUNLAR":"games","🔮 TAROT & RİTÜEL":"tarot","👤 ÜYELİK / GİRİŞ":"membership","🏆 PROFİL / XP":"profile","🪙 MONTENOIR KASASI":"cashier","☰ MENU":"menu","⚙️ AYARLAR":"settings",
"← Ana sayfa":"back","Aç":"open","Satın Al":"buy","Katıl":"join","Kabul Et":"accept","Gönder":"send",
"☰ MONTENOIR VIP MENU":"menuTitle","Tüm ek sistemler tek yerde.":"menuSub","🎟️ Turnuvalar":"tournaments","Turnuvalar ve ödüller.":"tournamentsDesc",
"🎨 Profil Özelleştirme":"custom","Çerçeve, renk ve profil stilleri.":"customDesc","🎁 Sandık Sistemi":"chests","Sandıklar ve ödüller.":"chestsDesc",
"🏆 Başarımlar":"achievements","Profil başarımları.":"achievementsDesc","👥 Arkadaş Sistemi":"friends","Arkadaşlar ve özel mesajlar.":"friendsDesc",
"🤖 AI Tarot Premium":"ai","Premium kişisel tarot yorumu.":"aiDesc","📜 Oyun Kuralları":"rules","Codenames, Poker, Tavla, Okey, 101, Monopoly, Ludo ve Bowling kuralları.":"rulesDesc",
"Dil, tema, bildirimler ve gizlilik.":"settingsDesc","🌍 Dil":"language","🎨 Tema":"theme","🔔 Bildirimler":"notifications","🔐 Gizlilik":"privacy","❓ Yardım":"help",
"Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"rulesSimple","Siyah & altın MONTENOIR teması aktif.":"themeActive","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"notificationsSoon","Email diğer oyunculara gösterilmez.":"privacyText","Oyun kuralları ve destek bölümü yakında.":"helpText",
"🥉 Bronz Sandık":"chestBronze","🥈 Gümüş Sandık":"chestSilver","🥇 Altın Sandık":"chestGold","💎 Elmas Sandık":"chestDiamond",
"🟡 Altın Çerçeve":"goldFrame","💎 Elmas Çerçeve":"diamondFrame","🏛️ Barok Çerçeve":"baroqueFrame","🌈 İsim Rengi":"rainbowName","✨ Animasyonlu Profil":"animatedProfile",
"Arkadaş Ekle":"friendAdd","Özel Mesaj Gönder":"privateMessage","Arkadaş kullanıcı adı":"friendUsername","Mesaj gönderilecek kullanıcı":"messageTarget","Mesaj":"messageText",
"Premium yorum: 1500 jeton":"premiumPrice","Doğum tarihi":"birthDate","Sorunu yaz":"question","Fotoğraf / enerji notu":"photoNote","Premium Yorumu Al":"premiumButton",
"👑 Haftalık Codenames Turnuvası":"weeklyCodenames","Giriş: 100 jeton":"entry100","Ödül: 5.000 jeton":"prize5000","♠️ Poker Turnuvası":"pokerTournament","Yakında":"soon",
"Yükleniyor...":"loading","Henüz başarım yok.":"noAchievement","Arkadaşlar":"friendsTitle","İstekler":"requestsTitle","Yok":"none"
};
function lang(){return localStorage.getItem("montenoirLang")||"tr";}
function t(key){return (LANGS[lang()]||LANGS.tr)[key]||LANGS.tr[key]||key;}
function apply(){
...
document.querySelectorAll("button,a,h1,h2,h3,p,div,span,option").forEach(el=>{
 if(el.children.length>0 && !el.classList.contains("royalBtn") && !el.classList.contains("btn") && !el.classList.contains("gameItem")) return;
 let s=(el.textContent||"").trim(); if(BASE[s]) el.textContent=t(BASE[s]);
});
document.querySelectorAll("input,textarea").forEach(el=>{let s=el.getAttribute("placeholder")||""; if(BASE[s]) el.setAttribute("placeholder",t(BASE[s]));});
}
window.setMontenoirLang=function(v){localStorage.setItem("montenoirLang",v);apply();};
document.addEventListener("DOMContentLoaded",apply); setTimeout(apply,300); setTimeout(apply,1000);

(function(){
const PATCH={
tr:{"Ayarlar":"Ayarlar","⚙️ Ayarlar":"⚙️ Ayarlar","Kurallar":"Kurallar","📜 Kurallar":"📜 Kurallar","Seçim tarayıcıda kaydedilir.":"Seçim tarayıcıda kaydedilir.","Language":"Dil","Thème":"Tema","Confidentialité":"Gizlilik","Aide":"Yardım"},
fr:{"Ayarlar":"Paramètres","⚙️ Ayarlar":"⚙️ Paramètres","Kurallar":"Règles","📜 Kurallar":"📜 Règles","Seçim tarayıcıda kaydedilir.":"Le choix est enregistré dans le navigateur.","Language":"Langue","Thème":"Thème","Confidentialité":"Confidentialité","Aide":"Aide"},
en:{"Ayarlar":"Settings","⚙️ Ayarlar":"⚙️ Settings","Kurallar":"Rules","📜 Kurallar":"📜 Rules","Seçim tarayıcıda kaydedilir.":"The choice is saved in the browser.","Language":"Language","Thème":"Theme","Confidentialité":"Privacy","Aide":"Help"},
es:{"Ayarlar":"Ajustes","⚙️ Ayarlar":"⚙️ Ajustes","Kurallar":"Reglas","📜 Kurallar":"📜 Reglas","Seçim tarayıcıda kaydedilir.":"La elección se guarda en el navegador.","Language":"Idioma","Thème":"Tema","Confidentialité":"Privacidad","Aide":"Ayuda"},
de:{"Ayarlar":"Einstellungen","⚙️ Ayarlar":"⚙️ Einstellungen","Kurallar":"Regeln","📜 Kurallar":"📜 Regeln","Seçim tarayıcıda kaydedilir.":"Die Auswahl wird im Browser gespeichert.","Language":"Sprache","Thème":"Thema","Confidentialité":"Datenschutz","Aide":"Hilfe"},
it:{"Ayarlar":"Impostazioni","⚙️ Ayarlar":"⚙️ Impostazioni","Kurallar":"Regole","📜 Kurallar":"📜 Regole","Seçim tarayıcıda kaydedilir.":"La scelta viene salvata nel browser.","Language":"Lingua","Thème":"Tema","Confidentialité":"Privacy","Aide":"Aiuto"},
pt:{"Ayarlar":"Definições","⚙️ Ayarlar":"⚙️ Definições","Kurallar":"Regras","📜 Kurallar":"📜 Regras","Seçim tarayıcıda kaydedilir.":"A escolha é guardada no navegador.","Language":"Idioma","Thème":"Tema","Confidentialité":"Privacidade","Aide":"Ajuda"},
nl:{"Ayarlar":"Instellingen","⚙️ Ayarlar":"⚙️ Instellingen","Kurallar":"Regels","📜 Kurallar":"📜 Regels","Seçim tarayıcıda kaydedilir.":"De keuze wordt opgeslagen in de browser.","Language":"Taal","Thème":"Thema","Confidentialité":"Privacy","Aide":"Hulp"},
ro:{"Ayarlar":"Setări","⚙️ Ayarlar":"⚙️ Setări","Kurallar":"Reguli","📜 Kurallar":"📜 Reguli","Seçim tarayıcıda kaydedilir.":"Alegerea este salvată în browser.","Language":"Limbă","Thème":"Temă","Confidentialité":"Confidențialitate","Aide":"Ajutor"},
ar:{"Ayarlar":"الإعدادات","⚙️ Ayarlar":"⚙️ الإعدادات","Kurallar":"القواعد","📜 Kurallar":"📜 القواعد","Seçim tarayıcıda kaydedilir.":"يتم حفظ الاختيار في المتصفح.","Language":"اللغة","Thème":"المظهر","Confidentialité":"الخصوصية","Aide":"المساعدة"},
ru:{"Ayarlar":"Настройки","⚙️ Ayarlar":"⚙️ Настройки","Kurallar":"Правила","📜 Kurallar":"📜 Правила","Seçim tarayıcıda kaydedilir.":"Выбор сохраняется в браузере.","Language":"Язык","Thème":"Тема","Confidentialité":"Конфиденциальность","Aide":"Помощь"}
};
function montePatch(){
 const lang=localStorage.getItem("montenoirLang")||"tr";
 const d=PATCH[lang]||PATCH.tr;
 document.documentElement.dir=(lang==="ar")?"rtl":"ltr";
 document.querySelectorAll("h1,h2,h3,p,div,span,button,a").forEach(el=>{
   if(el.children.length>0 && !el.classList.contains("btn") && !el.classList.contains("royalBtn") && !el.classList.contains("item")) return;
   const s=(el.textContent||"").trim();
   if(d[s]) el.textContent=d[s];
 });
}
document.addEventListener("DOMContentLoaded",montePatch);
setTimeout(montePatch,400);
setTimeout(montePatch,1200);
window.addEventListener("storage",montePatch);
const oldSet=window.setMontenoirLang;
window.setMontenoirLang=function(v){
 if(oldSet) oldSet(v); else localStorage.setItem("montenoirLang",v);
 setTimeout(montePatch,50);
 setTimeout(montePatch,500);
};
})();
...
# =========================
# MONTENOIR SAFE SYSTEMS HELPERS
# =========================
...
def monte_unlock_achievements(users, key):
    ...
    if int(u.get("openedChests", 0)) >= 1: ach.add("🎁 İlk Sandık")
...
@app.route("/tarot")
def tarot_world():
    return render_template_string(TAROT_HTML + MONTENOIR_I18N_SCRIPT)
...
<div class="panel"><h2>🪙 Jeton Bakiyesi</h2><p>Jeton satın alma artık sadece MONTENOIR Kasası üzerinden yapılır.</p><button class="btn" onclick="location.href='/kasa'">🪙 MONTENOIR KASASI</button></div></div>
...
<title>MONTENOIR VIP Casino</title>
<style>
*{box-sizing:border-box}
body{margin:0;min-height:100vh;color:#fff;font-family:Arial,Helvetica,sans-serif;overflow-x:hidden;text-align:center;background:radial-gradient(circle at 50% 25%,#30220a 0,#090909 38%,#000 100%)}
body:before{content:"";position:fixed;inset:0;pointer-events:none;background:radial-gradient(circle at 10% 15%,rgba(212,175,55,.18),transparent 18%),radial-gradient(circle at 90% 20%,rgba(212,175,55,.13),transparent 20%),linear-gradient(135deg,rgba(255,215,0,.08),transparent 35%,rgba(255,215,0,.06))}
.stage{position:relative;min-height:100vh;padding:34px 16px 70px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:22px}.logo{font-family:Georgia,serif;font-size:clamp(42px,7vw,86px);letter-spacing:7px;color:#f6d777;text-shadow:0 0 12px #d4af37,0 0 45px rgba(212,175,55,.75);margin:0}.subtitle{color:#d4af37;letter-spacing:4px;text-transform:uppercase;margin-top:-10px;font-weight:bold}.cards{position:absolute;inset:0;pointer-events:none;overflow:hidden;opacity:.95}.card{position:absolute;width:115px;height:160px;border-radius:16px;background:linear-gradient(145deg,#161616,#020202);border:2px solid #d4af37;box-shadow:0 0 25px rgba(212,175,55,.45);display:flex;align-items:center;justify-content:center;flex-direction:column;font-family:Georgia,serif;color:#f6d777;font-weight:900}.card b{font-size:50px}.card span{font-size:35px}.c1{left:5%;top:8%;transform:rotate(-16deg)}.c2{right:6%;top:9%;transform:rotate(15deg)}.c3{left:8%;bottom:9%;transform:rotate(13deg)}.c4{right:8%;bottom:8%;transform:rotate(-13deg)}
.table{position:relative;z-index:2;width:min(760px,92vw);min-height:355px;border-radius:50%;background:radial-gradient(circle at 50% 35%,#16814d 0,#075c36 48%,#032615 100%);border:12px solid #4b2a08;box-shadow:0 0 0 4px #d4af37,0 30px 90px rgba(0,0,0,.9),inset 0 0 80px rgba(0,0,0,.55);display:flex;align-items:center;justify-content:center;flex-direction:column;padding:45px 22px}.table:before{content:"";position:absolute;inset:22px;border-radius:50%;border:2px dashed rgba(255,215,120,.45)}.btnRow{z-index:3;display:flex;gap:18px;flex-wrap:wrap;justify-content:center}.royalBtn{min-width:220px;padding:18px 22px;border-radius:18px;border:2px solid #d4af37;background:linear-gradient(135deg,#060606,#2a1c06,#080808);color:#f8dc83;font-size:19px;font-weight:900;letter-spacing:1px;cursor:pointer;box-shadow:0 0 18px rgba(212,175,55,.42);transition:.2s}.royalBtn:hover{transform:translateY(-3px) scale(1.03);box-shadow:0 0 30px rgba(212,175,55,.85)}.menuPanel{z-index:4;margin-top:18px;display:none;width:min(650px,90vw);border:2px solid #d4af37;border-radius:24px;background:rgba(0,0,0,.78);box-shadow:0 0 35px rgba(212,175,55,.4);padding:22px;position:relative}.menuPanel.show{display:block;animation:pop .22s ease}.menuPanel:before{content:"";position:absolute;top:-17px;left:50%;transform:translateX(-50%);border-left:17px solid transparent;border-right:17px solid transparent;border-bottom:17px solid #d4af37}.gameGrid{display:grid;grid-template-columns:repeat(auto-fit,minmax(170px,1fr));gap:12px}.gameItem{display:block;text-decoration:none;padding:15px 10px;border-radius:16px;border:1px solid rgba(212,175,55,.65);background:linear-gradient(145deg,rgba(255,255,255,.08),rgba(0,0,0,.75));color:#fff;font-weight:800}.gameItem:hover{background:linear-gradient(145deg,#d4af37,#3a2605);color:#000}.soon{opacity:.75}.note{font-size:13px;color:#d8c184;margin-top:14px}.footer{position:relative;z-index:2;color:#bda35b;font-size:13px}@keyframes pop{from{opacity:0;transform:translateY(-10px) scale(.97)}to{opacity:1;transform:translateY(0) scale(1)}}@media(max-width:720px){.card{width:78px;height:108px}.card b{font-size:34px}.card span{font-size:25px}.table{min-height:310px}.royalBtn{min-width:190px}}

.homeModal{display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,.82);align-items:center;justify-content:center;padding:18px}.homeModalContent{width:min(460px,92vw);border:2px solid #d4af37;border-radius:24px;background:linear-gradient(145deg,#050505,#1c1303);box-shadow:0 0 45px rgba(212,175,55,.55);padding:24px;color:#f6d777}.homeModalContent input{width:100%;margin:7px 0;padding:12px;border-radius:12px;border:1px solid #d4af37;background:#090909;color:#fff}.homeModalContent button{margin:5px;padding:10px 14px;border-radius:12px;border:1px solid #d4af37;background:#111;color:#f6d777;font-weight:bold}.closeHome{float:right}.homeStatus{font-size:13px;color:#fff;margin-top:10px}.homeProfileLine{margin:10px 0;padding:12px;border:1px solid rgba(212,175,55,.5);border-radius:14px;background:rgba(255,255,255,.05)}
.langFloat{position:fixed;right:14px;top:14px;z-index:99999;background:#050505;border:1px solid #d4af37;border-radius:12px;color:#f6d777;padding:8px;box-shadow:0 0 14px rgba(212,175,55,.45)}
.langFloat select{background:#050505;color:#f6d777;border:0;outline:0;font-weight:bold}

</style>
</head>
<body><div class="langFloat"><select id="montenoirLangSelectHome" onchange="setMontenoirLang(this.value)"><option value="tr">🇹🇷 TR</option><option value="fr">🇫🇷 FR</option><option value="en">🇬🇧 EN</option><option value="es">🇪🇸 ES</option><option value="de">🇩🇪 DE</option><option value="it">🇮🇹 IT</option><option value="pt">🇵🇹 PT</option><option value="nl">🇳🇱 NL</option><option value="ro">🇷🇴 RO</option><option value="ar">🇸🇦 AR</option><option value="ru">🇷🇺 RU</option></select></div><div class="stage"><div class="cards"><div class="card c1"><b>A</b><span>♠</span></div><div class="card c2"><b>K</b><span>♥</span></div><div class="card c3"><b>Q</b><span>♦</span></div><div class="card c4"><b>J</b><span>♣</span></div></div><h1 class="logo">🏛️ MONTENOIR VIP</h1><div class="subtitle">Casino · Oyun · Tarot & Ritüel</div><main class="table"><div class="btnRow"><button class="royalBtn" onclick="toggleGames()">🎮 OYUNLAR</button><button class="royalBtn" onclick="openAuthHome()">👤 ÜYELİK / GİRİŞ</button><button class="royalBtn" onclick="openProfileHome()">🏆 PROFİL / XP</button><button class="royalBtn" onclick="location.href='/kasa'">🪙 MONTENOIR KASASI</button><button class="royalBtn" onclick="location.href='/menu'">☰ MENU</button><button class="royalBtn" onclick="location.href='/ayarlar'">⚙️ AYARLAR</button></div><section id="gamesPanel" class="menuPanel"><div class="gameGrid"><a class="gameItem" href="/codenames">👑 Codenames VIP</a><a class="gameItem soon" href="/coming-soon/Poker">♠️ Poker</a><a class="gameItem soon" href="/coming-soon/Tavla">🎲 Tavla</a><a class="gameItem soon" href="/coming-soon/Okey">🀄 Okey</a><a class="gameItem soon" href="/coming-soon/101">💎 101</a><a class="gameItem soon" href="/coming-soon/Monopoly">🏙️ Monopoly</a><a class="gameItem soon" href="/coming-soon/Ludo">🔴 Ludo</a><a class="gameItem soon" href="/coming-soon/Bowling">🎳 Bowling</a></div><div class="note">Şimdilik Codenames VIP oynanabilir. Diğer oyunlar tek tek eklenecek.</div></section></main><div class="footer"><div class="footerLine"></div><div class="footerText">🏛️ MONTENOIR VIP ♠ ♦ ♣ ♥</div></div><div class="footer"></div></div><div id="homeAuthModal" class="homeModal"><div class="homeModalContent"><button class="closeHome" onclick="closeHomeModals()">X</button><h2>👤 Üyelik</h2><h3>📝 Kayıt Ol</h3><input id="hRegUsername" placeholder="Kullanıcı adı"><input id="hRegEmail" type="email" placeholder="Email"><input id="hRegPassword" type="password" placeholder="Şifre"><input id="hRegPassword2" type="password" placeholder="Şifre tekrar"><button onclick="homeRegister()">Kayıt Ol</button><hr><h3>🔐 Giriş Yap</h3><input id="hLoginUsername" placeholder="Kullanıcı adı"><input id="hLoginPassword" type="password" placeholder="Şifre"><button onclick="homeLogin()">Giriş Yap</button><button onclick="homeLogout()">Çıkış Yap</button><div id="homeAuthStatus" class="homeStatus">Henüz giriş yapılmadı.</div></div></div><div id="homeProfileModal" class="homeModal"><div class="homeModalContent"><button class="closeHome" onclick="closeHomeModals()">X</button><h2>🏆 Profil / XP</h2><div id="homeProfileBox" class="homeStatus">Giriş yapmadın.</div><button onclick="location.href='/codenames'">🎮 Codenames VIP’e Git</button></div></div><script src="https://cdn.socket.io/4.7.5/socket.io.min.js"></script><script>const homeSocket=io();let homeProfile=null;function toggleGames(){document.getElementById('gamesPanel').classList.toggle('show')}function closeHomeModals(){homeAuthModal.style.display='none';homeProfileModal.style.display='none'}function openAuthHome(){homeAuthModal.style.display='flex';homeAuthStatus.innerHTML=localStorage.getItem('codenamesAccount')?'Connecté : '+localStorage.getItem('codenamesAccount'):'Henüz giriş yapılmadı.'}function openProfileHome(){homeProfileModal.style.display='flex';let a=localStorage.getItem('codenamesAccount');if(a){homeSocket.emit('request_profile',{account:a});homeProfileBox.innerHTML='Profil yükleniyor...'}else{homeProfileBox.innerHTML='Giriş yapmadın. Önce üyelik/giriş yap.'}}function homeXP(p){return ((p.wins||0)*100)+((p.games||0)*10)}function renderHomeProfile(p){homeProfile=p;localStorage.setItem('codenamesAccount',p.username);localStorage.setItem('loggedUser',p.username);localStorage.setItem('loggedIn','true');localStorage.setItem('codenamesProfile',JSON.stringify(p));homeProfileBox.innerHTML='<div class="homeProfileLine"><b>👤 '+p.username+'</b><br>🏆 XP: '+homeXP(p)+'<br>🪙 Jeton: '+(p.chips||0)+'<br>🎖️ Rozet: '+(p.membershipLabel||'Yok')+'</div>'}function homeRegister(){let u=hRegUsername.value.trim(),e=hRegEmail.value.trim(),p=hRegPassword.value,p2=hRegPassword2.value;if(!u||!e||!p||!p2){alert('Tüm alanları doldur.');return}if(p!==p2){alert('Şifreler aynı değil.');return}homeSocket.emit('register_account',{username:u,email:e,password:p,avatar:'woman.png'})}function homeLogin(){let u=hLoginUsername.value.trim(),p=hLoginPassword.value;if(!u||!p){alert('Kullanıcı adı ve şifre yaz.');return}homeSocket.emit('login_account',{username:u,password:p})}function homeLogout(){localStorage.removeItem('codenamesAccount');localStorage.removeItem('loggedUser');localStorage.removeItem('loggedIn');localStorage.removeItem('codenamesProfile');homeProfile=null;homeAuthStatus.innerHTML='Çıkış yapıldı.';homeProfileBox.innerHTML='Giriş yapmadın.'}homeSocket.on('register_result',d=>{if(!d.ok){alert(d.msg);return}renderHomeProfile(d.profile);closeHomeModals();alert('Hesap oluşturuldu.')});homeSocket.on('login_result',d=>{if(!d.ok){alert(d.msg);return}renderHomeProfile(d.profile);closeHomeModals();alert('Giriş yapıldı.')});homeSocket.on('profile_fresh',p=>renderHomeProfile(p));</script></body></html>
'''
...
/* MONTENOIR VIP: oyun içinde üyelik/tarot/shop yok; sadece profil + XP */
...
@app.route('/')
def home():
    return render_template_string(HOME_HTML + MONTENOIR_I18N_SCRIPT)
...
<div class="card"><h2>⚙️ Ayarlar</h2><p>Dil, tema, bildirimler ve gizlilik.</p><a class="btn" href="/ayarlar">Aç</a></div>
</div>
</div>
</body></html>
"""
...
KASA_HTML = r"""
<!DOCTYPE html><html lang="tr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>🪙 MONTENOIR Kasası</title>
<style>body{margin:0;min-height:100vh;background:radial-gradient(circle at top,#2b1d05,#000);color:#f6d777;font-family:Arial;text-align:center}.wrap{max-width:1000px;margin:auto;padding:35px 18px}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:18px}.pack{border:1px solid #d4af37;border-radius:22px;background:rgba(0,0,0,.75);padding:22px;box-shadow:0 0 22px rgba(212,175,55,.3)}.price{font-size:26px;color:#fff0a8}.btn{padding:12px 18px;border-radius:14px;border:1px solid #d4af37;background:#d4af37;color:#000;font-weight:900;cursor:pointer}.back{color:#d4af37}</style></head><body><div class="wrap"><a class="back" href="/">← Ana sayfa</a><h1>🪙 MONTENOIR KASASI</h1><div class="grid">
<div class="pack"><h2>Başlangıç</h2><div class="price">🪙 200</div><p>4,99 €</p><button class="btn">Satın Al</button></div>
<div class="pack"><h2>Gümüş</h2><div class="price">🪙 500</div><p>9,99 €</p><button class="btn">Satın Al</button></div>
<div class="pack"><h2>Altın</h2><div class="price">🪙 1.200</div><p>19,99 €</p><button class="btn">Satın Al</button></div>
<div class="pack"><h2>VIP</h2><div class="price">🪙 3.000</div><p>39,99 €</p><button class="btn">Satın Al</button></div>
<div class="pack"><h2>Elmas</h2><div class="price">🪙 8.000</div><p>89,99 €</p><button class="btn">Satın Al</button></div>
</div><p style="color:#f4dfb0">Stripe/PayPal bağlandığında butonlar gerçek ödeme alacak.</p></div>{MONTENOIR_I18N_SCRIPT}</body></html>
"""
...
def settings_page():
    ...
    <h2>⚙️ Ayarlar</h2>
    <div class='grid'>
      <div class='item'><h3>🌍 Dil</h3><p>Seçim tarayıcıda kaydedilir.</p>
      ...
      <div class='item'><h3>📜 Kurallar</h3><p>Saygılı oyun, hile yasak, uygunsuz davranış yasak.</p></div>
      <div class='item'><h3>🎨 Tema</h3><p>Siyah & altın MONTENOIR teması aktif.</p></div>
      <div class='item'><h3>🔔 Bildirimler</h3><p>Turnuva, sandık ve özel mesaj bildirimleri yakında.</p></div>
      <div class='item'><h3>🔐 Gizlilik</h3><p>Email diğer oyunculara gösterilmez.</p></div>
      <div class='item'><h3>❓ Yardım</h3><p>Oyun kuralları ve destek bölümü yakında.</p></div>
    </div>
    """
...
(function(){
const D={
tr:["🎮 OYUNLAR","🔮 TAROT & RİTÜEL","👤 ÜYELİK / GİRİŞ","🏆 PROFİL / XP","🪙 MONTENOIR KASASI","☰ MENU","⚙️ AYARLAR","🎟️ Turnuvalar","🎨 Profil Özelleştirme","🎁 Sandık Sistemi","🏆 Başarımlar","👥 Arkadaş Sistemi","🤖 AI Tarot Premium","📜 Oyun Kuralları","Satın Al","Aç","← Ana sayfa"],
fr:["🎮 JEUX","🔮 TAROT & RITUEL","👤 ABONNEMENT / CONNEXION","🏆 PROFIL / XP","🪙 CAISSE MONTENOIR","☰ MENU","⚙️ PARAMÈTRES","🎟️ Tournois","🎨 Personnalisation profil","🎁 Coffres","🏆 Succès","👥 Amis","🤖 Tarot IA Premium","📜 Règles des jeux","Acheter","Ouvrir","← Accueil"],
en:["🎮 GAMES","🔮 TAROT & RITUAL","👤 MEMBERSHIP / LOGIN","🏆 PROFILE / XP","🪙 MONTENOIR CASHIER","☰ MENU","⚙️ SETTINGS","🎟️ Tournaments","🎨 Profile customization","🎁 Chests","🏆 Achievements","👥 Friends","🤖 Premium AI Tarot","📜 Game rules","Buy","Open","← Home"],
es:["🎮 JUEGOS","🔮 TAROT Y RITUAL","👤 MEMBRESÍA / ENTRAR","🏆 PERFIL / XP","🪙 CAJA MONTENOIR","☰ MENU","⚙️ AJUSTES","🎟️ Torneos","🎨 Personalización perfil","🎁 Cofres","🏆 Logros","👥 Amigos","🤖 Tarot IA Premium","📜 Reglas de juego","Comprar","Abrir","← Inicio"],
de:["🎮 SPIELE","🔮 TAROT & RITUAL","👤 MITGLIEDSCHAFT / LOGIN","🏆 PROFIL / XP","🪙 MONTENOIR KASSE","☰ MENU","⚙️ EINSTELLUNGEN","🎟️ Turniere","🎨 Profil anpassen","🎁 Truhen","🏆 Erfolge","👥 Freunde","🤖 Premium KI-Tarot","📜 Spielregeln","Kaufen","Öffnen","← Startseite"],
it:["🎮 GIOCHI","🔮 TAROCCHI & RITUALE","👤 ABBONAMENTO / LOGIN","🏆 PROFILO / XP","🪙 CASSA MONTENOIR","☰ MENU","⚙️ IMPOSTAZIONI","🎟️ Tornei","🎨 Personalizza profilo","🎁 Forzieri","🏆 Obiettivi","👥 Amici","🤖 Tarocchi IA Premium","📜 Regole dei giochi","Acquista","Apri","← Home"],
pt:["🎮 JOGOS","🔮 TAROT & RITUAL","👤 ADESÃO / LOGIN","🏆 PERFIL / XP","🪙 CAIXA MONTENOIR","☰ MENU","⚙️ DEFINIÇÕES","🎟️ Torneios","🎨 Personalizar perfil","🎁 Baús","🏆 Conquistas","👥 Amigos","🤖 Tarot IA Premium","📜 Regras dos jogos","Comprar","Abrir","← Início"],
nl:["🎮 SPELLEN","🔮 TAROT & RITUEEL","👤 LIDMAATSCHAP / LOGIN","🏆 PROFIEL / XP","🪙 MONTENOIR KASSA","☰ MENU","⚙️ INSTELLINGEN","🎟️ Toernooien","🎨 Profiel aanpassen","🎁 Kisten","🏆 Prestaties","👥 Vrienden","🤖 Premium AI Tarot","📜 Spelregels","Kopen","Openen","← Home"],
ro:["🎮 JOCURI","🔮 TAROT & RITUAL","👤 ABONAMENT / LOGIN","🏆 PROFIL / XP","🪙 CASIERIA MONTENOIR","☰ MENU","⚙️ SETĂRI","🎟️ Turnee","🎨 Personalizare profil","🎁 Cufere","🏆 Realizări","👥 Prieteni","🤖 Tarot AI Premium","📜 Regulile jocurilor","Cumpără","Deschide","← Acasă"],
...
ru:["🎮 ИГРЫ","🔮 ТАРО И РИТУАЛ","👤 ПОДПИСКА / ВХОД","🏆 ПРОФИЛЬ / XP","🪙 КАССА MONTENOIR","☰ МЕНЮ","⚙️ НАСТРОЙКИ","🎟️ Турниры","🎨 Настройка профиля","🎁 Сундуки","🏆 Достижения","👥 Друзья","🤖 Премиум AI Таро","📜 Правила игр","Купить","Открыть","← Главная"]
};
const base=D.tr;
...
# =========================
# MONTENOIR SAFE SYSTEMS ROUTES V1
# =========================
