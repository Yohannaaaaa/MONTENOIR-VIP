...
<button onclick="safeOpenAuth()">👤 Üyelik</button>
<button onclick="safeOpenProfile()">🏆 Profil</button>
<button onclick="safeOpenRanking()">📊 Classement</button>
<button onclick="safeOpenSettings()">⚙️ Ayarlar</button>
<button onclick="safeOpenWords()">📚 Kelimeler</button>
<button onclick="safeOpenBet()">🎰 Bahis</button>
<button onclick="safeOpenShop()">🪙 Jeton Al</button>
<button id="ownerPanelBtn" style="display:none;" onclick="openOwnerPanel();closeMainMenu()">👑 Owner Panel</button>
</div>
</div>
<button class="mainTopBtn" onclick="safeStartTimer()">⏱ Süre</button>
<button class="mainTopBtn" onclick="safeNewGame()">🎲 Yeni Oyun</button>
<button class="mainTopBtn" onclick="safeGoLobby()">🚪 Lobi</button>
</div>
</div>
</div>
