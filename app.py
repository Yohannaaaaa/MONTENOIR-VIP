...
.hero{position:relative;min-height:100vh;width:100%;background:linear-gradient(90deg,rgba(0,0,0,.72),rgba(0,0,0,.2) 36%,rgba(0,0,0,.22) 64%,rgba(0,0,0,.76)),linear-gradient(180deg,rgba(0,0,0,.76),rgba(0,0,0,.18) 48%,rgba(0,0,0,.88)),url("/static/montenoir_home.png") center/cover no-repeat}
