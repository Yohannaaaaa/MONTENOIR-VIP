...
<button id="tarotTopBtn" class="tarotTopBtn" type="button" onclick="location.href='/tarot'">🚪 ✦ 🔮 TAROT & RITUEL ✦</button>
<div class="compactMenuWrap">
<button class="menuToggleBtn" type="button" onclick="toggleMainMenu(event)">☰ Menü</button>
<div id="mainCompactMenu" class="compactMenu">
<button type="button" onclick="openAuth();closeMainMenu()">👤 Üyelik</button>
<button type="button" onclick="openProfile();closeMainMenu()">🏆 Profil</button>
<button type="button" onclick="openRanking();closeMainMenu()">📊 Classement</button>
<button type="button" onclick="openSettings();closeMainMenu()">⚙️ Ayarlar</button>
<button type="button" onclick="openWords();closeMainMenu()">📚 Kelimeler</button>
<button type="button" onclick="openBet();closeMainMenu()">🎰 Bahis</button>
<button type="button" onclick="openShop();closeMainMenu()">🪙 Jeton Al</button>
<button id="ownerPanelBtn" type="button" style="display:none;" onclick="openOwnerPanel();closeMainMenu()">👑 Owner Panel</button>
</div>
</div>
<button class="mainTopBtn" type="button" onclick="startTimer()">⏱ Süre</button>
<button class="mainTopBtn" type="button" onclick="newGame()">🎲 Yeni Oyun</button>
<button class="mainTopBtn" type="button" onclick="goLobby()">🚪 Lobi</button>
</div>
