...
(function(){
const M={
tr:{"⚙️ Ayarlar":"⚙️ Ayarlar","<span data-i18n="rulesTitle">📜 Kurallar</span>":"<span data-i18n="rulesTitle">📜 Kurallar</span>","Seçim tarayıcıda kaydedilir.":"Seçim tarayıcıda kaydedilir.","<span data-i18n="language">🌍 Dil</span>":"<span data-i18n="language">🌍 Dil</span>","<span data-i18n="theme">🎨 Tema</span>":"<span data-i18n="theme">🎨 Tema</span>","<span data-i18n="notifications">🔔 Bildirimler</span>":"<span data-i18n="notifications">🔔 Bildirimler</span>","<span data-i18n="privacy">🔐 Gizlilik</span>":"<span data-i18n="privacy">🔐 Gizlilik</span>","<span data-i18n="help">❓ Yardım</span>":"<span data-i18n="help">❓ Yardım</span>","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Turnuva, sandık ve özel mesaj bildirimleri yakında.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>"},
fr:{"⚙️ Ayarlar":"⚙️ Paramètres","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 Règles","Seçim tarayıcıda kaydedilir.":"Le choix est enregistré dans le navigateur.","<span data-i18n="language">🌍 Dil</span>":"🌍 Langue","<span data-i18n="theme">🎨 Tema</span>":"🎨 Thème","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 Notifications","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 Confidentialité","<span data-i18n="help">❓ Yardım</span>":"❓ Aide","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"Jeu respectueux, triche interdite, comportement abusif interdit.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"Le thème noir et or MONTENOIR est actif.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notifications de tournois, coffres et messages privés bientôt.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"L’e-mail n’est pas affiché aux autres joueurs.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"Règles de jeu et support bientôt disponibles."},
en:{"⚙️ Ayarlar":"⚙️ Settings","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 Rules","Seçim tarayıcıda kaydedilir.":"The choice is saved in the browser.","<span data-i18n="language">🌍 Dil</span>":"🌍 Language","<span data-i18n="theme">🎨 Tema</span>":"🎨 Theme","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 Notifications","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 Privacy","<span data-i18n="help">❓ Yardım</span>":"❓ Help","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"Respectful play, no cheating, no abusive behavior.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"The black and gold MONTENOIR theme is active.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Tournament, chest and private message notifications coming soon.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"Email is not shown to other players.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"Game rules and support coming soon."},
es:{"⚙️ Ayarlar":"⚙️ Ajustes","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 Reglas","Seçim tarayıcıda kaydedilir.":"La elección se guarda en el navegador.","<span data-i18n="language">🌍 Dil</span>":"🌍 Idioma","<span data-i18n="theme">🎨 Tema</span>":"<span data-i18n="theme">🎨 Tema</span>","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 Notificaciones","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 Privacidad","<span data-i18n="help">❓ Yardım</span>":"❓ Ayuda","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"Juego respetuoso, trampas prohibidas, comportamiento abusivo prohibido.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"El tema negro y dorado MONTENOIR está activo.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notificaciones de torneos, cofres y mensajes privados próximamente.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"El email no se muestra a otros jugadores.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"Reglas del juego y soporte próximamente."},
de:{"⚙️ Ayarlar":"⚙️ Einstellungen","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 Regeln","Seçim tarayıcıda kaydedilir.":"Die Auswahl wird im Browser gespeichert.","<span data-i18n="language">🌍 Dil</span>":"🌍 Sprache","<span data-i18n="theme">🎨 Tema</span>":"🎨 Thema","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 Benachrichtigungen","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 Datenschutz","<span data-i18n="help">❓ Yardım</span>":"❓ Hilfe","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"Respektvolles Spielen, Betrug verboten, beleidigendes Verhalten verboten.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"Das schwarz-goldene MONTENOIR-Theme ist aktiv.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Turnier-, Truhen- und Privatnachrichten-Benachrichtigungen kommen bald.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"Die E-Mail wird anderen Spielern nicht angezeigt.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"Spielregeln und Support folgen bald."},
it:{"⚙️ Ayarlar":"⚙️ Impostazioni","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 Regole","Seçim tarayıcıda kaydedilir.":"La scelta viene salvata nel browser.","<span data-i18n="language">🌍 Dil</span>":"🌍 Lingua","<span data-i18n="theme">🎨 Tema</span>":"<span data-i18n="theme">🎨 Tema</span>","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 Notifiche","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 Privacy","<span data-i18n="help">❓ Yardım</span>":"❓ Aiuto","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"Gioco rispettoso, trucchi vietati, comportamento abusivo vietato.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"Il tema nero e oro MONTENOIR è attivo.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notifiche per tornei, forzieri e messaggi privati presto disponibili.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"L’email non viene mostrata agli altri giocatori.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"Regole del gioco e supporto presto disponibili."},
pt:{"⚙️ Ayarlar":"⚙️ Definições","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 Regras","Seçim tarayıcıda kaydedilir.":"A escolha é guardada no navegador.","<span data-i18n="language">🌍 Dil</span>":"🌍 Idioma","<span data-i18n="theme">🎨 Tema</span>":"<span data-i18n="theme">🎨 Tema</span>","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 Notificações","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 Privacidade","<span data-i18n="help">❓ Yardım</span>":"❓ Ajuda","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"Jogo respeitoso, batota proibida, comportamento abusivo proibido.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"O tema preto e dourado MONTENOIR está ativo.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notificações de torneios, baús e mensagens privadas em breve.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"O email não é mostrado a outros jogadores.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"Regras do jogo e suporte em breve."},
nl:{"⚙️ Ayarlar":"⚙️ Instellingen","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 Regels","Seçim tarayıcıda kaydedilir.":"De keuze wordt opgeslagen in de browser.","<span data-i18n="language">🌍 Dil</span>":"🌍 Taal","<span data-i18n="theme">🎨 Tema</span>":"🎨 Thema","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 Meldingen","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 Privacy","<span data-i18n="help">❓ Yardım</span>":"❓ Hulp","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"Respectvol spelen, vals spelen verboden, beledigend gedrag verboden.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"Het zwart-gouden MONTENOIR-thema is actief.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Meldingen voor toernooien, kisten en privéberichten komen binnenkort.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"E-mail wordt niet getoond aan andere spelers.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"Spelregels en ondersteuning binnenkort beschikbaar."},
ro:{"⚙️ Ayarlar":"⚙️ Setări","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 Reguli","Seçim tarayıcıda kaydedilir.":"Alegerea este salvată în browser.","<span data-i18n="language">🌍 Dil</span>":"🌍 Limbă","<span data-i18n="theme">🎨 Tema</span>":"🎨 Temă","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 Notificări","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 Confidențialitate","<span data-i18n="help">❓ Yardım</span>":"❓ Ajutor","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"Joc respectuos, trișatul este interzis, comportamentul abuziv este interzis.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"Tema negru și auriu MONTENOIR este activă.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notificările pentru turnee, cufere și mesaje private vin curând.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"Emailul nu este afișat altor jucători.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"Regulile jocului și suportul vor fi disponibile curând."},
ar:{"⚙️ Ayarlar":"⚙️ الإعدادات","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 القواعد","Seçim tarayıcıda kaydedilir.":"يتم حفظ الاختيار في المتصفح.","<span data-i18n="language">🌍 Dil</span>":"🌍 اللغة","<span data-i18n="theme">🎨 Tema</span>":"🎨 المظهر","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 الإشعارات","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 الخصوصية","<span data-i18n="help">❓ Yardım</span>":"❓ المساعدة","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"اللعب باحترام، الغش ممنوع، والسلوك المسيء ممنوع.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"سمة MONTENOIR السوداء والذهبية مفعلة.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"إشعارات البطولات والصناديق والرسائل الخاصة قريباً.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"لا يتم عرض البريد الإلكتروني للاعبين الآخرين.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"قواعد الألعاب والدعم قريباً."},
ru:{"⚙️ Ayarlar":"⚙️ Настройки","<span data-i18n="rulesTitle">📜 Kurallar</span>":"📜 Правила","Seçim tarayıcıda kaydedilir.":"Выбор сохраняется в браузере.","<span data-i18n="language">🌍 Dil</span>":"🌍 Язык","<span data-i18n="theme">🎨 Tema</span>":"🎨 Тема","<span data-i18n="notifications">🔔 Bildirimler</span>":"🔔 Уведомления","<span data-i18n="privacy">🔐 Gizlilik</span>":"🔐 Конфиденциальность","<span data-i18n="help">❓ Yardım</span>":"❓ Помощь","<span data-i18n="rulesText">Saygılı oyun, hile yasak, uygunsuz davranış yasak.</span>":"Уважительная игра, мошенничество запрещено, оскорбительное поведение запрещено.","<span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span>":"Чёрно-золотая тема MONTENOIR активна.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Уведомления о турнирах, сундуках и личных сообщениях скоро.","<span data-i18n="privacyText">Email diğer oyunculara gösterilmez.</span>":"Email не показывается другим игрокам.","<span data-i18n="helpText">Oyun kuralları ve destek bölümü yakında.</span>":"Правила игр и поддержка скоро будут доступны."}
};
...
<div class="panel"><h2>🪙 Jeton Bakiyesi</h2><p>Jeton satın alma artık sadece MONTENOIR Kasası üzerinden yapılır.</p><button class="btn" onclick="location.href='/kasa'">🪙 <span data-i18n="cashier">MONTENOIR KASASI</span></button></div></div>
...
# =========================
# MONTENOIR ONLINE MATRIX SYSTEM
# =========================
ONLINE_USERS = {}
...
def montenoir_user_online(data):
    ...
    joined = {"username": username, "gender": gender, "symbol": online_symbol_for({"gender": gender})}
...
.topbar{position:absolute;top:0;left:0;right:0;z-index:30;height:92px;display:flex;align-items:center;justify-content:space-between;padding:18px 28px;background:linear-gradient(180deg,rgba(0,0,0,.85),rgba(0,0,0,.18));border-bottom:1px solid rgba(212,175,55,.22)}
...
.topBtn{height:58px;min-width:190px;border-radius:14px;border:1px solid rgba(212,175,55,.82);background:linear-gradient(180deg,rgba(0,0,0,.76),rgba(0,0,0,.48));color:#fff;font-size:17px;font-weight:900;cursor:pointer;letter-spacing:.3px;box-shadow:0 0 15px rgba(0,0,0,.45), inset 0 0 12px rgba(212,175,55,.05)}
.topBtn.premium{background:linear-gradient(180deg,#f0c366,#916015);border-color:#ffd882;color:#fff;box-shadow:0 0 22px rgba(212,175,55,.45), inset 0 1px 0 rgba(255,255,255,.25)}
...
@media(max-width:900px){.home{background-size:cover;background-position:center top}.topbar{height:auto;gap:10px}.topRight{flex-wrap:wrap;justify-content:flex-end}.topBtn{min-width:145px;font-size:14px}.bottomCards{display:none}.bottomMain{bottom:86px;gap:10px}.bigAction{height:58px;font-size:16px;max-width:46vw}.sidePanel{left:8px;top:84px}}
</style>
</head>
<body>
<div class="home">
  <header class="topbar">
    <button class="menuTop" onclick="toggleMenu()"><span data-i18n="menu">☰ MENÜ</span></button>
    <div class="topRight">
  ...
  <div class="bottomMain">
    <button class="bigAction gold" onclick="toggleGames()"><i>🎴</i> <span data-i18n="games">OYUNLAR</span></button>
    <button class="bigAction" onclick="location.href='/tarot'"><i>🔮</i> <span data-i18n="tarot">TAROT & RİTÜEL</span></button>
  </div>
  ...
  <aside id="sidePanel" class="sidePanel">
    <div class="panelSection">
      ...
      <a class="panelLink" href="/kasa"><b>🪙</b><span data-i18n="cashier">MONTENOIR KASASI</span></a>
    ...
    <div class="panelSection" id="settingsPart">
      ...
      <div class="setting"><h3><span data-i18n="theme">🎨 Tema</span></h3><p><span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span></p></div>
  ...
  <div class="bottomCards">
    <div class="card"><div class="cardIcon">🎁</div><div class="cardText"><span data-i18n="daily">GÜNLÜK ÖDÜL</span><small><span data-i18n="dailyText">Hediyeni almayı unutma!</span></small></div><button><span data-i18n="take">AL</span></button></div>
...
const I18N = {
tr:{
menu:"☰ MENÜ", login:"👤 ÜYELİK / GİRİŞ", premium:"♛ PREMIUM ÜYELİK",
games:"OYUNLAR", tarot:"TAROT & RİTÜEL", ai:"AI TAROT PREMIUM", tournaments:"TURNUVALAR",
friends:"ARKADAŞLAR", settings:"AYARLAR", cashier:"MONTENOIR KASASI", rules:"OYUN KURALLARI",
...
theme:"🎨 Tema", themeText:"Siyah & altın MONTENOIR teması aktif.",
...
friends:"AMIS", settings:"PARAMÈTRES", cashier:"CAISSE MONTENOIR", rules:"RÈGLES DU JEU",
...
theme:"🎨 Thème", themeText:"Le thème noir et or MONTENOIR est actif.",
...
friends:"FRIENDS", settings:"SETTINGS", cashier:"MONTENOIR CASHIER", rules:"GAME RULES",
...
theme:"🎨 Theme", themeText:"The black and gold MONTENOIR theme is active.",
...
friends:"AMIGOS", settings:"AJUSTES", cashier:"CAJA MONTENOIR", rules:"REGLAS DEL JUEGO",
...
theme:"🎨 Tema", themeText:"El tema negro y dorado MONTENOIR está activo.",
...
de:{
menu:"☰ MENÜ", login:"👤 MITGLIEDSCHAFT / LOGIN", premium:"♛ PREMIUM-MITGLIEDSCHAFT",
games:"SPIELE", tarot:"TAROT & RITUAL", ai:"PREMIUM KI-TAROT", tournaments:"TURNIERE",
friends:"FREUNDE", settings:"EINSTELLUNGEN", cashier:"MONTENOIR KASSE", rules:"SPIELREGELN",
...
theme:"🎨 Thema", themeText:"Das schwarz-goldene MONTENOIR-Theme ist aktiv.",
...
friends:"AMICI", settings:"IMPOSTAZIONI", cashier:"CASSA MONTENOIR", rules:"REGOLE DEL GIOCO",
...
theme:"🎨 Tema", themeText:"Il tema nero e oro MONTENOIR è attivo.",
...
friends:"AMIGOS", settings:"DEFINIÇÕES", cashier:"CAIXA MONTENOIR", rules:"REGRAS DO JOGO",
...
theme:"🎨 Tema", themeText:"O tema preto e dourado MONTENOIR está ativo.",
...
friends:"VRIENDEN", settings:"INSTELLINGEN", cashier:"MONTENOIR KASSA", rules:"SPELREGELS",
...
theme:"🎨 Thema", themeText:"Het zwart-gouden MONTENOIR-thema is actief.",
...
friends:"PRIETENI", settings:"SETĂRI", cashier:"CASIERIA MONTENOIR", rules:"REGULILE JOCULUI",
...
theme:"🎨 Temă", themeText:"Tema negru și auriu MONTENOIR este activă.",
...
theme:"🎨 المظهر", themeText:"سمة MONTENOIR السوداء والذهبية مفعلة.",
...
friends:"ДРУЗЬЯ", settings:"НАСТРОЙКИ", cashier:"КАССА MONTENOIR", rules:"ПРАВИЛА ИГРЫ",
...
theme:"🎨 Тема", themeText:"Чёрно-золотая тема MONTENOIR активна.",
...
<style>
#montenoirOnlineBox{position:fixed;top:10px;right:10px;width:148px;height:92px;z-index:9997;background:rgba(0,0,0,.86);border:1px solid rgba(212,175,55,.75);border-radius:8px;box-shadow:0 0 14px rgba(0,255,90,.22),0 0 18px rgba(212,175,55,.22);overflow:hidden;font-family:Consolas,"Courier New",monospace;color:#00ff66;font-size:10.5px;line-height:17px}
...
@media(max-width:700px){#montenoirOnlineBox{width:118px;height:76px;font-size:9px;line-height:15px;top:8px;right:8px}#montenoirOnlineHeader{height:18px;font-size:9px}#montenoirOnlineViewport{height:56px}}
</style>
...
(function(){
  ...
  function showToast(user){if(!user||!user.username)return;var wrap=document.getElementById("montenoirLoginToastWrap");if(!wrap)return;var toast=document.createElement("div");toast.className="montenoirLoginToast";toast.textContent=(user.symbol||symbolFor(user.gender))+" "+user.username+" giriş yaptı";wrap.appendChild(toast);setTimeout(function(){toast.remove()},5000);}
  ...
  document.addEventListener("DOMContentLoaded",announceOnline);setTimeout(announceOnline,500);setInterval(announceOnline,30000);
...
def settings_page():
    ...
    <div class='grid'>
      ...
      <div class='item'><h3><span data-i18n="theme">🎨 Tema</span></h3><p><span data-i18n="themeText">Siyah & altın MONTENOIR teması aktif.</span></p></div>
