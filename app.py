...
.home{
  ...
  background:
    linear-gradient(90deg,rgba(0,0,0,.10),rgba(0,0,0,.03) 35%,rgba(0,0,0,.05) 68%,rgba(0,0,0,.18)),
    linear-gradient(180deg,rgba(0,0,0,.18),rgba(0,0,0,.02) 45%,rgba(0,0,0,.30)),
    url('/static/montenoir_home.png') center top / 100% 100% no-repeat;
}
.home:before{
  content:"";position:absolute;inset:0;pointer-events:none;
  background:radial-gradient(circle at 50% 38%,rgba(0,0,0,.05),rgba(0,0,0,.30) 58%,rgba(0,0,0,.55) 100%);
}
.topbar{
  position:absolute;top:0;left:0;right:0;z-index:20;
  height:104px;display:flex;align-items:center;padding:0 34px;
  background:linear-gradient(180deg,rgba(0,0,0,.92),rgba(0,0,0,.50),rgba(0,0,0,.08));
  border-bottom:1px solid rgba(212,175,55,.22);
  box-shadow:0 14px 40px rgba(0,0,0,.28)
}
.brand{
  width:220px;color:#d4af37;text-align:center;font-family:Georgia,'Times New Roman',serif;
  font-size:28px;font-weight:500;letter-spacing:1.3px;line-height:.88;
  text-shadow:0 0 10px rgba(212,175,55,.42),0 2px 2px #000;
}
.brand:before{content:"♛";display:block;font-size:31px;line-height:.85;margin-bottom:6px;color:#d4af37}
.brand small{display:block;font-size:14px;letter-spacing:5px;margin-top:8px;position:relative}
.brand small:before,.brand small:after{content:"";display:inline-block;width:48px;height:1px;background:#d4af37;vertical-align:middle;margin:0 8px;opacity:.75}
.nav{flex:1;display:flex;align-items:stretch;justify-content:center;height:100%;gap:0}
.nav a,.nav button{
  height:104px;min-width:155px;padding:8px 14px;border:0;border-left:1px solid rgba(212,175,55,.22);
  background:linear-gradient(180deg,rgba(255,255,255,.025),rgba(0,0,0,.02));
  color:#fff;text-decoration:none;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;
  font-size:15px;font-weight:900;letter-spacing:.2px;text-shadow:0 3px 5px #000;cursor:pointer;
}
.nav a:last-child,.nav button:last-child{border-right:1px solid rgba(212,175,55,.22)}
.nav i{font-style:normal;font-size:34px;color:#d4af37;line-height:1;filter:drop-shadow(0 0 8px rgba(212,175,55,.55))}
.nav small{color:#d4af37;font-size:11px;margin-top:-4px;letter-spacing:.9px}
.nav a:hover,.nav button:hover{background:linear-gradient(180deg,rgba(212,175,55,.16),rgba(212,175,55,.03));color:#ffe59a}
.userBlock{display:flex;align-items:center;gap:10px;margin-left:15px;min-width:160px;color:#fff;font-weight:900}
.userCircle{
  width:54px;height:54px;border-radius:50%;border:1px solid #d4af37;
  background:radial-gradient(circle,rgba(212,175,55,.12),rgba(0,0,0,.70));display:grid;place-items:center;color:#d4af37;
  box-shadow:0 0 15px rgba(212,175,55,.25)
}
.userBlock small{color:#d4af37;display:block;margin-top:4px}
.menuTop{
  margin-left:12px;width:132px;height:58px;border:1px solid #d4af37;border-radius:31px;
  background:linear-gradient(180deg,rgba(0,0,0,.74),rgba(0,0,0,.32));color:#d4af37;
  font-size:18px;font-weight:500;letter-spacing:.6px;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:14px;
  box-shadow:inset 0 0 12px rgba(212,175,55,.06),0 0 15px rgba(212,175,55,.18)
}
.menuTop:before{content:"☰";font-size:28px}
.menuTop:hover{background:#d4af37;color:#050505}
.centerUI{
  position:absolute;z-index:10;left:50%;top:39%;transform:translate(-50%,-50%);
  width:min(470px,86vw);display:flex;flex-direction:column;align-items:center;text-align:center
}
.bigLogo{
  width:150px;height:116px;margin-bottom:8px;display:grid;place-items:center;
  color:#d4af37;text-shadow:0 0 18px rgba(212,175,55,.72);filter:drop-shadow(0 0 11px rgba(212,175,55,.45));
}
.bigLogo:before{
  content:"♛";font-size:92px;line-height:1;
}
.mainTitle{
  font-family:Georgia,'Times New Roman',serif;font-size:clamp(56px,7vw,92px);font-weight:600;letter-spacing:2.5px;color:#d4af37;line-height:.9;
  text-shadow:0 0 18px rgba(212,175,55,.55),0 3px 2px #000;
  background:linear-gradient(180deg,#fff0a8,#d4af37 45%,#8a5a12 100%);
  -webkit-background-clip:text;background-clip:text;color:transparent;
}
.mainVip{
  font-family:Georgia,'Times New Roman',serif;font-size:35px;letter-spacing:13px;color:#f6d777;margin:12px 0 28px;
  text-shadow:0 0 10px rgba(212,175,55,.45),0 2px 2px #000;position:relative
}
.mainVip:before,.mainVip:after{content:"";position:absolute;top:50%;width:105px;height:1px;background:#d4af37;opacity:.75}
.mainVip:before{right:calc(100% + 18px)}.mainVip:after{left:calc(100% + 6px)}
.mainButtons{display:flex;flex-direction:column;gap:12px;width:100%;align-items:center}
.mainButtons button{
  width:360px;max-width:86vw;height:58px;border-radius:31px;font-size:22px;font-weight:900;letter-spacing:.4px;cursor:pointer;
  text-shadow:0 2px 4px #000;transition:.15s;
}
.playBtn{
  border:1px solid rgba(255,224,150,.95);
  background:linear-gradient(180deg,#f7d988 0%,#c89436 45%,#9d6517 100%);
  color:#fff;box-shadow:inset 0 1px 0 rgba(255,255,255,.38), inset 0 -8px 15px rgba(0,0,0,.18),0 0 22px rgba(212,175,55,.36)
}
.darkBtn{
  border:1px solid rgba(212,175,55,.85);
  background:linear-gradient(180deg,rgba(0,0,0,.72),rgba(0,0,0,.46));
  color:#fff;box-shadow:inset 0 0 14px rgba(212,175,55,.05),0 0 15px rgba(0,0,0,.4)
}
.mainButtons button:hover{transform:translateY(-2px);box-shadow:0 0 30px rgba(212,175,55,.65)}
.sidePanel{
  display:none;position:fixed;right:16px;top:112px;bottom:28px;z-index:80;width:min(385px,94vw);overflow:auto;
  border:1px solid rgba(212,175,55,.55);border-radius:9px;
  background:linear-gradient(180deg,rgba(16,12,5,.86),rgba(5,5,5,.86));backdrop-filter:blur(7px);
  box-shadow:0 0 38px rgba(0,0,0,.72),inset 0 0 22px rgba(212,175,55,.05)
}
.sidePanel.show{display:block}
.panelSection{padding:25px 24px;border-bottom:1px solid rgba(212,175,55,.24)}
.panelTitle{color:#d4af37;font-size:22px;font-weight:500;letter-spacing:.4px;margin-bottom:14px}
.panelLink{
  display:flex;align-items:center;gap:13px;color:#fff;text-decoration:none;font-weight:800;font-size:16px;min-height:58px;padding:12px 14px;
  border:1px solid rgba(212,175,55,.26);border-bottom:0;background:rgba(255,255,255,.035);text-shadow:0 2px 3px #000
}
.panelLink:first-of-type{border-radius:8px 8px 0 0}.panelLink:last-of-type{border-bottom:1px solid rgba(212,175,55,.26);border-radius:0 0 8px 8px}
.panelLink:hover{background:rgba(212,175,55,.14)}
.panelLink b{font-size:24px;color:#d4af37;min-width:28px;filter:drop-shadow(0 0 6px rgba(212,175,55,.35))}
.setting{border:1px solid rgba(212,175,55,.26);background:rgba(255,255,255,.035);border-radius:8px;padding:13px;margin-bottom:10px;color:#ddd}
.setting h3{margin:0 0 8px;font-size:18px;color:#fff;text-shadow:0 2px 3px #000}.setting p{margin:0;font-size:14px;line-height:1.36;color:#ddd}
...
.bottomCards{
  position:absolute;left:28px;right:28px;bottom:22px;z-index:15;display:grid;grid-template-columns:repeat(4,1fr);gap:14px
}
.card{
  height:79px;border:1px solid rgba(212,175,55,.32);border-radius:11px;background:linear-gradient(180deg,rgba(20,18,14,.82),rgba(5,5,5,.78));
  display:flex;align-items:center;gap:14px;padding:12px 18px;box-shadow:0 0 18px rgba(0,0,0,.5),inset 0 0 12px rgba(212,175,55,.04)
}
.cardIcon{font-size:35px;color:#d4af37;filter:drop-shadow(0 0 6px rgba(212,175,55,.35))}
.cardText{font-size:15px;font-weight:900;color:#fff;line-height:1.1;text-shadow:0 2px 3px #000}.cardText small{display:block;color:#d7c28a;font-size:12px;font-weight:500;margin-top:6px}
.card button{margin-left:auto;border:1px solid #d4af37;border-radius:18px;background:linear-gradient(180deg,#c99d45,#5a3608);color:#fff;padding:8px 16px;font-weight:900;cursor:pointer}
...
.gamesPanel{display:none;position:fixed;z-index:90;left:50%;top:50%;transform:translate(-50%,-50%);width:min(560px,92vw);border:1px solid #d4af37;border-radius:14px;background:rgba(5,5,5,.92);padding:22px;box-shadow:0 0 35px rgba(0,0,0,.85)}
.gamesPanel.show{display:block}.gameGrid{display:grid;grid-template-columns:repeat(2,1fr);gap:10px}.gameGrid a{border:1px solid rgba(212,175,55,.35);border-radius:12px;padding:14px;color:#fff;text-decoration:none;font-weight:900;background:rgba(255,255,255,.04)}.gameGrid a:hover{background:rgba(212,175,55,.16)}
@media(max-width:1100px){.nav{display:none}.userBlock{display:none}.topbar{justify-content:space-between}.brand{width:auto;font-size:22px}.bottomCards{display:none}.home{background-size:cover;background-position:center top}.centerUI{top:46%}}
@media(max-width:640px){.mainTitle{font-size:48px}.bigLogo{width:90px;height:70px}.bigLogo:before{font-size:60px}.mainVip{font-size:26px}.mainButtons button{height:52px;font-size:18px}.sidePanel{right:8px;top:88px}}
</style>
</head>
<body>
<div class="home">
  <div class="topbar">
    ...
    <div class="nav">
      <a href="/tarot"><i>🃏</i>TAROT & RİTÜEL</a>
      <a href="/turnuvalar"><i>🏆</i>TURNUVALAR</a>
      <a href="/ai-tarot-premium"><i>💎</i>AI TAROT<small>PREMIUM</small></a>
      <a href="/arkadaslar"><i>👥</i>ARKADAŞLAR</a>
      <button onclick="openSettingsPanel()"><i>⚙️</i>AYARLAR</button>
    </div>
    <div class="userBlock"><div class="userCircle">👤</div><div><span id="miniUser">Yohanna</span><small>VIP ♛</small></div></div>
    <button class="menuTop" onclick="toggleMenu()">☰ MENÜ</button>
  </div>

  <div class="centerUI">
    <div class="bigLogo">♛</div>
    <div class="mainTitle">MONTENOIR</div>
    <div class="mainVip">VIP</div>
    <div class="mainButtons">
      <button class="playBtn" onclick="toggleGames()">OYUNLAR</button>
      <button class="darkBtn" onclick="openAuthHome()">👤 ÜYELİK / GİRİŞ</button>
      <button class="darkBtn" onclick="location.href='/premium'">💎 PREMIUM ÜYELİK</button>
    </div>
  </div>

  <aside id="sidePanel" class="sidePanel">
    <div class="panelSection" id="menuPart">
      <div class="panelTitle">MENÜ</div>
      <a class="panelLink" href="/kasa"><b>🪙</b>MONTENOIR KASASI</a>
      <a class="panelLink" href="/oyun-kurallari"><b>📜</b>OYUN KURALLARI</a>
      <a class="panelLink" href="/sandiklar"><b>🎁</b>SANDIK SİSTEMİ</a>
      <a class="panelLink" href="/profil-magazasi"><b>🎨</b>PROFİL ÖZELLEŞTİRME</a>
      <a class="panelLink" href="#" onclick="openProfileHome();return false;"><b>🏆</b>PROFİL / XP</a>
    </div>
    <div class="panelSection" id="settingsPart">
      <div class="panelTitle">AYARLAR</div>
      <div class="setting"><h3>🌍 Dil</h3><select id="montenoirLangSelect" onchange="setMontenoirLang(this.value)"><option value="tr">🇹🇷 Türkçe</option><option value="fr">🇫🇷 Français</option><option value="en">🇬🇧 English</option><option value="es">🇪🇸 Español</option><option value="de">🇩🇪 Deutsch</option><option value="it">🇮🇹 Italiano</option><option value="pt">🇵🇹 Português</option><option value="nl">🇳🇱 Nederlands</option><option value="ro">🇷🇴 Română</option><option value="ar">🇸🇦 العربية</option><option value="ru">🇷🇺 Русский</option></select></div>
      <div class="setting"><h3>📜 Kurallar</h3><p>Saygılı oyun, hile yasak, uygunsuz davranış yasak.</p></div>
      <div class="setting"><h3>🎨 Tema</h3><p>Siyah & altın MONTENOIR teması aktif.</p></div>
      <div class="setting"><h3>🔔 Bildirimler</h3><p>Turnuva, sandık ve özel mesaj ve davet bildirimleri yakında.</p></div>
      <div class="setting"><h3>🔐 Gizlilik</h3><p>Email diğer oyunculara gösterilmez.</p></div>
      <div class="setting"><h3>❓ Yardım</h3><p>Oyun kuralları ve destek bölümü yakında.</p></div>
    </div>
  </aside>

  <section id="gamesPanel" class="gamesPanel">
    <div class="panelTitle">🎮 OYUNLAR</div>
    <div class="gameGrid">
      ...
      <a href="/coming-soon/101">💎 101</a><a href="/coming-soon/Monopoly">🏙️ Monopoly</a>
      <a href="/coming-soon/Ludo">🔴 Ludo</a><a href="/coming-soon/Bowling">🎳 Bowling</a>
    </div>
  </section>

  <div class="bottomCards">
    <div class="card"><div class="cardIcon">🎁</div><div class="cardText">GÜNLÜK ÖDÜL<small>Hediyeni almayı unutma!</small></div><button>AL</button></div>
    <div class="card"><div class="cardIcon">🏆</div><div class="cardText">AKTİF TURNUVA<small>Haftalık Codenames Turnuvası</small></div><button onclick="location.href='/turnuvalar'">KATIL</button></div>
    <div class="card"><div class="cardIcon">⭐</div><div class="cardText">VIP PUANIN<small>12.450</small></div><button onclick="openProfileHome()">DETAYLAR</button></div>
    <div class="card"><div class="cardIcon">👥</div><div class="cardText">ARKADAŞLAR<small>32 Çevrimiçi</small></div><button onclick="location.href='/arkadaslar'">GÖRÜNTÜLE</button></div>
  </div>
</div>
...
function openAuthHome(){homeAuthModal.style.display='flex'}
...
function homeLogout(){localStorage.removeItem('codenamesAccount');localStorage.removeItem('loggedUser');localStorage.removeItem('loggedIn');miniUser.innerText='Yohanna';homeAuthStatus.innerHTML='Çıkış yapıldı.'}
function renderHomeProfile(p){localStorage.setItem('codenamesAccount',p.username);localStorage.setItem('loggedUser',p.username);localStorage.setItem('loggedIn','true');miniUser.innerText=p.username;homeProfileBox.innerHTML='<b>👤 '+p.username+'</b><br>⭐ Seviye: '+(p.level||1)+'<br>🏆 XP: '+(p.xp||0)+'<br>🪙 Jeton: '+(p.chips||0)+'<br>🎖️ Rozet: '+(p.membershipLabel||'Yok')}
