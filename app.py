...
def codenames():
    ...
    <body style="margin:0;background:#050505;color:#d4af37;font-family:Georgia,serif;text-align:center;padding:50px;min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center">
        <h1 style="font-size:48px;letter-spacing:3px;margin-bottom:20px">🎯 CODENAMES VIP</h1>
        <p style="font-size:18px;margin-bottom:30px">Jeu de mots en équipe</p>
        <p style="color:#d4af37;margin:20px 0">Codenames arrive bientôt...</p>
        <a href="/games" style="display:inline-block;margin-top:30px;padding:14px 30px;background:linear-gradient(180deg,#d4af37,#8a6a1f);color:#050505;text-decoration:none;border-radius:8px;font-weight:bold">← Retour aux jeux</a>
    </body>
    </html>
    """)
...
def games():
    ...
    <body>
        <div class="wrap">
            <header>
                <h1>JEUX MONTENOIR</h1>
                <p style="font-size:18px;margin-top:10px">Choisis ton jeu!</p>
            </header>
            <div class="grid">
                <a href="/metropoly" class="card">
                    <div class="emoji">H</div>
                    <div class="name">METROPOLY LUXE</div>
                </a>
                <a href="/codenames" class="card">
                    <div class="emoji">X</div>
                    <div class="name">CODENAMES VIP</div>
                </a>
            </div>
            <a href="/" class="back">← Retour accueil</a>
        </div>
