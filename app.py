...
@app.route("/metropoly", endpoint="metropoly_3d_final")
@app.route("/monopoly", endpoint="monopoly_alias_3d_final")
def metropoly_3d_final():
    return render_template("metropoly.html")


@app.route("/", endpoint="accueil_luxe_montenoir_cover")
def accueil_luxe_montenoir_cover():
