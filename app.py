...
@app.route("/", endpoint="route_accueil_montenoir_final")
def route_accueil_montenoir_final():
    return render_template("index.html")

@app.route("/metropoly", endpoint="route_metropoly_final")
@app.route("/monopoly", endpoint="route_monopoly_alias_final")
def route_metropoly_final():
