...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>🏛️ MONTENOIR VIP Menü</title>
<style>
...
<h1>🏛️ MONTENOIR VIP Menü</h1>
<div class="grid">

<div class="card"><h2>🎟️ Turnuvalar</h2><p>Turnuvalar ve ödüller.</p><a class="btn" href="/turnuvalar">Aç</a></div>
<div class="card"><h2>🎨 Profil Özelleştirme</h2><p>Çerçeve, renk ve profil stilleri.</p></div>
<div class="card"><h2>🎁 Sandık Sistemi</h2><p>Sandıklar ve ödüller.</p><a class="btn" href="/sandiklar">Sandıkları Aç</a></div>
<div class="card"><h2>🏆 Başarımlar</h2><p>Profil başarımları.</p><a class="btn" href="/basarimlar">Gör</a></div>
<div class="card"><h2>👥 Arkadaş Sistemi</h2><p>Arkadaşlar ve mesajlar.</p><a class="btn" href="/arkadaslar">Aç</a></div>
<div class="card"><h2>🤖 AI Tarot Premium</h2><p>Premium kişisel tarot yorumu.</p><a class="btn" href="/ai-tarot-premium">Başlat</a></div>
</div>
</div>
</body></html>
"""
...
def ai_tarot_premium_page():
    content = """<p>Premium AI tarot için kullanıcı doğum tarihi, soru ve fotoğraf notu gönderecek.</p><p>Sonraki sürümde uzun kişisel yorum motoru bağlanacak.</p>"""
