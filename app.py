...
.home{
  ...
  background:
    linear-gradient(180deg,rgba(0,0,0,.34),rgba(0,0,0,.05) 40%,rgba(0,0,0,.42)),
    url('/static/montenoir_home.png') center top / 100% 100% no-repeat;
}
.topbar{
  position:absolute;top:0;left:0;right:0;z-index:30;height:92px;
  display:flex;align-items:center;justify-content:space-between;
  padding:18px 28px;background:linear-gradient(180deg,rgba(0,0,0,.85),rgba(0,0,0,.18));
  border-bottom:1px solid rgba(212,175,55,.22)
}
.menuTop{
  width:140px;height:58px;border:1px solid #d4af37;border-radius:14px;
  background:linear-gradient(180deg,rgba(10,8,3,.85),rgba(0,0,0,.55));color:#d4af37;
  font-size:19px;font-weight:900;letter-spacing:.5px;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:12px;
  box-shadow:0 0 16px rgba(212,175,55,.26),inset 0 0 12px rgba(212,175,55,.05)
}
.menuTop:hover{background:#d4af37;color:#050505}
.topRight{display:flex;align-items:center;gap:14px}
.topBtn{
  height:58px;min-width:190px;border-radius:14px;border:1px solid rgba(212,175,55,.82);
  background:linear-gradient(180deg,rgba(0,0,0,.76),rgba(0,0,0,.48));
  color:#fff;font-size:17px;font-weight:900;cursor:pointer;letter-spacing:.3px;
  box-shadow:0 0 15px rgba(0,0,0,.45), inset 0 0 12px rgba(212,175,55,.05)
}
.topBtn.premium{
  background:linear-gradient(180deg,#f0c366,#916015);
  border-color:#ffd882;color:#fff;box-shadow:0 0 22px rgba(212,175,55,.45), inset 0 1px 0 rgba(255,255,255,.25)
}
.topBtn:hover{transform:translateY(-1px);box-shadow:0 0 26px rgba(212,175,55,.55)}
.userBlock{
  display:none;align-items:center;gap:10px;color:#fff;font-weight:900;
  border:1px solid rgba(212,175,55,.52);border-radius:28px;padding:6px 12px;background:rgba(0,0,0,.55)
}
...
.bottomMain{
  position:absolute;z-index:20;left:50%;bottom:88px;transform:translateX(-50%);
  display:flex;gap:18px;align-items:center;justify-content:center;width:min(760px,92vw)
}
.bigAction{
  width:360px;max-width:45vw;height:70px;border-radius:14px;border:1px solid #d4af37;
  background:linear-gradient(180deg,rgba(20,17,10,.86),rgba(0,0,0,.72));
  color:#fff;font-size:22px;font-weight:900;letter-spacing:.6px;cursor:pointer;
  display:flex;align-items:center;justify-content:center;gap:16px;
  box-shadow:0 0 20px rgba(0,0,0,.55), inset 0 0 18px rgba(212,175,55,.05)
}
.bigAction i{font-style:normal;font-size:34px;color:#d4af37;filter:drop-shadow(0 0 6px rgba(212,175,55,.45))}
.bigAction.gold{
  background:linear-gradient(180deg,#f6d782,#ad741f);
  color:#fff;border-color:#ffe09a;text-shadow:0 2px 4px #000;
  box-shadow:0 0 28px rgba(212,175,55,.55), inset 0 1px 0 rgba(255,255,255,.30)
}
.bigAction:hover{transform:translateY(-2px);box-shadow:0 0 32px rgba(212,175,55,.60)}
.sidePanel{
  display:none;position:fixed;left:18px;top:104px;bottom:24px;z-index:90;width:min(395px,94vw);overflow:auto;
  border:1px solid rgba(212,175,55,.62);border-radius:12px;
  background:linear-gradient(180deg,rgba(12,9,4,.92),rgba(3,3,3,.88));backdrop-filter:blur(7px);
  box-shadow:0 0 42px rgba(0,0,0,.76),inset 0 0 24px rgba(212,175,55,.05)
}
...
.panelLink{
  display:flex;align-items:center;gap:14px;min-height:58px;padding:13px 15px;color:#fff;text-decoration:none;
  border:1px solid rgba(212,175,55,.28);border-bottom:0;background:rgba(255,255,255,.04);
  font-size:16px;font-weight:900;text-shadow:0 2px 3px #000
}
.panelLink:first-of-type{border-radius:8px 8px 0 0}
.panelLink:last-of-type{border-bottom:1px solid rgba(212,175,55,.28);border-radius:0 0 8px 8px}
.panelLink:hover{background:rgba(212,175,55,.14)}
.panelLink b{font-size:25px;color:#d4af37;min-width:30px;text-align:center;filter:drop-shadow(0 0 5px rgba(212,175,55,.38))}
...
.bottomCards{
  position:absolute;left:28px;right:28px;bottom:12px;z-index:15;
  display:grid;grid-template-columns:repeat(3,1fr);gap:14px
}
.card{
  height:66px;border:1px solid rgba(212,175,55,.32);border-radius:11px;background:linear-gradient(180deg,rgba(20,18,14,.82),rgba(5,5,5,.78));
  display:flex;align-items:center;gap:12px;padding:10px 16px;box-shadow:0 0 18px rgba(0,0,0,.5),inset 0 0 12px rgba(212,175,55,.04)
}
...
.gamesPanel{
  display:none;position:fixed;z-index:95;left:50%;bottom:174px;transform:translateX(-50%);width:min(620px,92vw);
  border:1px solid #d4af37;border-radius:14px;background:rgba(5,5,5,.92);padding:22px;box-shadow:0 0 35px rgba(0,0,0,.85)
}
.gamesPanel.show{display:block}
.gameGrid{display:grid;grid-template-columns:repeat(2,1fr);gap:10px}.gameGrid a{border:1px solid rgba(212,175,55,.35);border-radius:12px;padding:14px;color:#fff;text-decoration:none;font-weight:900;background:rgba(255,255,255,.04)}.gameGrid a:hover{background:rgba(212,175,55,.16)}
...
@media(max-width:900px){
 .home{background-size:cover;background-position:center top}.topbar{height:auto;gap:10px;align-items:flex-start}.topRight{flex-wrap:wrap;justify-content:flex-end}.topBtn{min-width:145px;font-size:14px}.userBlock{display:none!important}
 .bottomMain{bottom:86px;gap:10px}.bigAction{height:58px;font-size:16px;max-width:46vw}.bigAction i{font-size:26px}.bottomCards{display:none}.sidePanel{left:8px;top:84px}
}
</style>
</head>
<body>
<div class="home">
  <header class="topbar">
    ...
    <div class="topRight">
      <button class="topBtn" onclick="openAuthHome()">👤 ÜYELİK / GİRİŞ</button>
      <button class="topBtn premium" onclick="location.href='/premium'">♛ PREMIUM ÜYELİK</button>
      <div id="userBlock" class="userBlock"><div class="userCircle">👤</div><div><span id="miniUser">Üye</span><small>VIP</small></div></div>
    </div>
  </header>

  <div class="bottomMain">
    <button class="bigAction gold" onclick="toggleGames()"><i>🎴</i> OYUNLAR</button>
    <button class="bigAction" onclick="location.href='/tarot'"><i>🔮</i> TAROT & RİTÜEL</button>
  </div>

  <aside id="sidePanel" class="sidePanel">
    <div class="panelSection">
      <div class="panelTitle">MENÜ</div>
      <a class="panelLink" href="/ai-tarot-premium"><b>💎</b>AI TAROT PREMIUM</a>
      <a class="panelLink" href="/turnuvalar"><b>🏆</b>TURNUVALAR</a>
      <a class="panelLink" href="/arkadaslar"><b>👥</b>ARKADAŞLAR</a>
      <a class="panelLink" href="#" onclick="openSettingsPanel();return false;"><b>⚙️</b>AYARLAR</a>
    ...
    <div class="panelSection" id="settingsPart">
      ...
      <div class="setting"><h3>🔔 Bildirimler</h3><p>Turnuva, sandık, özel mesaj ve davet bildirimleri yakında.</p></div>
...
function openProfileHome(){homeProfileModal.style.display='flex';let a=localStorage.getItem('codenamesAccount')||localStorage.getItem('loggedUser');if(a){homeSocket.emit('request_profile',{account:a});homeProfileBox.innerHTML='Profil yükleniyor...'}else{homeProfileBox.innerHTML='Giriş yapmadın. Önce üyelik/giriş yap.'}}
...
function homeLogout(){localStorage.removeItem('codenamesAccount');localStorage.removeItem('loggedUser');localStorage.removeItem('loggedIn');localStorage.removeItem('codenamesProfile');userBlock.classList.remove('show');homeAuthStatus.innerHTML='Çıkış yapıldı.'}
function renderHomeProfile(p){localStorage.setItem('codenamesAccount',p.username);localStorage.setItem('loggedUser',p.username);localStorage.setItem('loggedIn','true');localStorage.setItem('codenamesProfile',JSON.stringify(p));miniUser.innerText=p.username;userBlock.classList.add('show');homeProfileBox.innerHTML='<b>👤 '+p.username+'</b><br>⭐ Seviye: '+(p.level||1)+'<br>🏆 XP: '+(p.xp||0)+'<br>🪙 Jeton: '+(p.chips||0)+'<br>🎖️ Rozet: '+(p.membershipLabel||'Yok')}
