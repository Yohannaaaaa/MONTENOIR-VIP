...
.menuTop{
  margin-left:12px;width:132px;height:54px;border:1px solid #d4af37;border-radius:31px;
...
.centerUI{
  position:absolute;z-index:10;left:50%;top:66%;transform:translate(-50%,-50%);
...
.mainButtons{display:flex;flex-direction:column;gap:10px;width:100%;align-items:center}
.mainButtons button{
  width:360px;max-width:86vw;height:54px;border-radius:31px;font-size:22px;font-weight:900;letter-spacing:.4px;cursor:pointer;
...
.panelLink{
  display:flex;align-items:center;gap:13px;color:#fff;text-decoration:none;font-weight:800;font-size:16px;min-height:54px;padding:12px 14px;
...
@media(max-width:1100px){.nav{display:none}.userBlock{display:none}.topbar{justify-content:space-between}.brand{width:auto;font-size:22px}.bottomCards{display:none}.home{background-size:cover;background-position:center top}.centerUI{top:68%}}
