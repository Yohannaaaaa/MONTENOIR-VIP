...
<div class="card"><h2>⚙️ Ayarlar</h2><p>Dil, kurallar, tema ve bildirimler.</p><a class="btn" href="/ayarlar">Aç</a></div>
</div>
</div>
</body></html>
"""
...
def tournaments_page():
    content = """<div class='grid'><div class='item'><h2>👑 Haftalık Codenames Turnuvası</h2><p>Giriş: 100 jeton</p><p>Ödül: 5.000 jeton</p><p>Durum: Yakında aktif</p></div><div class='item'><h2>♠️ Poker Turnuvası</h2><p>Yakında</p></div></div>"""
    return montenoir_page("🎟️ Turnuvalar", content)

@app.route("/profil-magazasi")
def profile_shop_page():
    content = """<div class='grid'><div class='item'>🟡 Altın Çerçeve<br>1000 jeton</div><div class='item'>💎 Elmas Çerçeve<br>5000 jeton</div><div class='item'>🏛️ Barok Çerçeve<br>7500 jeton</div><div class='item'>🌈 İsim Renkleri<br>500-3000 jeton</div><div class='item'>✨ Animasyonlu Profil<br>10000 jeton</div></div>"""
    return montenoir_page("🎨 Profil Özelleştirme", content)

@app.route("/sandiklar")
def chests_page():
    content = """<div class='grid'><div class='item'>🥉 Bronz Sandık<br>Jeton / küçük rozet</div><div class='item'>🥈 Gümüş Sandık<br>Jeton / isim rengi</div><div class='item'>🥇 Altın Sandık<br>Çerçeve / yüksek jeton</div><div class='item'>💎 Elmas Sandık<br>Nadir rozet / animasyon</div></div>"""
    return montenoir_page("🎁 Sandık Sistemi", content)

@app.route("/basarimlar")
def achievements_page():
    content = """<div class='grid'><div class='item'>🏆 İlk Zafer</div><div class='item'>🔥 10 Oyun Kazandı</div><div class='item'>🎮 100 Oyun Oynadı</div><div class='item'>🔮 Tarot Ustası</div><div class='item'>♠️ Poker Kralı</div></div>"""
    return montenoir_page("🏆 Başarımlar", content)

@app.route("/arkadaslar")
def friends_page():
    content = """<p>Arkadaş ekleme, özel mesaj ve çevrimiçi durum sistemi için temel sayfa hazırlandı.</p><div class='grid'><div class='item'>➕ Arkadaş Ekle</div><div class='item'>💬 Özel Mesaj</div><div class='item'>🟢 Çevrimiçi Durumu</div></div>"""
    return montenoir_page("👥 Arkadaş Sistemi", content)

@app.route("/ai-tarot-premium")
def ai_tarot_premium_page():
    content = """<p>Premium AI tarot için kullanıcı doğum tarihi, soru ve fotoğraf notu gönderecek.</p><p>Sonraki sürümde uzun kişisel yorum motoru bağlanacak.</p><a class='btn' href='/tarot'>Tarot sayfasına git</a>"""
...
def settings_page():
    ...
    <div class='grid'>
      <div class='item'><h3>🌍 Dil</h3><p>Seçim tarayıcıda kaydedilir.</p>
        <select onchange="setMontenoirLang(this.value);alert('Dil değiştirildi.')">
...
(function(){
const T={
tr:{home:"Ana sayfa",games:"OYUNLAR",tarot:"TAROT & RİTÜEL",membership:"ÜYELİK / GİRİŞ",profile:"PROFİL / XP",cashier:"MONTENOIR KASASI",menu:"MENU",custom:"PROFİL ÖZELLEŞTİRME",settings:"AYARLAR",tournaments:"Turnuvalar",chests:"Sandık Sistemi",achievements:"Başarımlar",friends:"Arkadaş Sistemi",ai:"AI Tarot Premium",rules:"Kurallar",language:"Dil",theme:"Tema",notifications:"Bildirimler",privacy:"Gizlilik",help:"Yardım",buy:"Satın Al",back:"← Ana sayfa",open:"Aç"},
fr:{home:"Accueil",games:"JEUX",tarot:"TAROT & RITUEL",membership:"ABONNEMENT / CONNEXION",profile:"PROFIL / XP",cashier:"CAISSE MONTENOIR",menu:"MENU",custom:"PERSONNALISATION PROFIL",settings:"PARAMÈTRES",tournaments:"Tournois",chests:"Coffres",achievements:"Succès",friends:"Amis",ai:"Tarot IA Premium",rules:"Règles",language:"Langue",theme:"Thème",notifications:"Notifications",privacy:"Confidentialité",help:"Aide",buy:"Acheter",back:"← Accueil",open:"Ouvrir"},
en:{home:"Home",games:"GAMES",tarot:"TAROT & RITUAL",membership:"MEMBERSHIP / LOGIN",profile:"PROFILE / XP",cashier:"MONTENOIR CASHIER",menu:"MENU",custom:"PROFILE CUSTOMIZATION",settings:"SETTINGS",tournaments:"Tournaments",chests:"Chest System",achievements:"Achievements",friends:"Friends",ai:"Premium AI Tarot",rules:"Rules",language:"Language",theme:"Theme",notifications:"Notifications",privacy:"Privacy",help:"Help",buy:"Buy",back:"← Home",open:"Open"},
es:{home:"Inicio",games:"JUEGOS",tarot:"TAROT Y RITUAL",membership:"MEMBRESÍA / ENTRAR",profile:"PERFIL / XP",cashier:"CAJA MONTENOIR",menu:"MENU",custom:"PERSONALIZACIÓN",settings:"AJUSTES",tournaments:"Torneos",chests:"Cofres",achievements:"Logros",friends:"Amigos",ai:"Tarot IA Premium",rules:"Reglas",language:"Idioma",theme:"Tema",notifications:"Notificaciones",privacy:"Privacidad",help:"Ayuda",buy:"Comprar",back:"← Inicio",open:"Abrir"},
de:{home:"Startseite",games:"SPIELE",tarot:"TAROT & RITUAL",membership:"MITGLIEDSCHAFT / LOGIN",profile:"PROFIL / XP",cashier:"MONTENOIR KASSE",menu:"MENU",custom:"PROFIL ANPASSEN",settings:"EINSTELLUNGEN",tournaments:"Turniere",chests:"Truhen",achievements:"Erfolge",friends:"Freunde",ai:"Premium KI-Tarot",rules:"Regeln",language:"Sprache",theme:"Thema",notifications:"Benachrichtigungen",privacy:"Datenschutz",help:"Hilfe",buy:"Kaufen",back:"← Startseite",open:"Öffnen"},
it:{home:"Home",games:"GIOCHI",tarot:"TAROCCHI & RITUALE",membership:"ABBONAMENTO / LOGIN",profile:"PROFILO / XP",cashier:"CASSA MONTENOIR",menu:"MENU",custom:"PERSONALIZZA PROFILO",settings:"IMPOSTAZIONI",tournaments:"Tornei",chests:"Forzieri",achievements:"Obiettivi",friends:"Amici",ai:"Tarocchi IA Premium",rules:"Regole",language:"Lingua",theme:"Tema",notifications:"Notifiche",privacy:"Privacy",help:"Aiuto",buy:"Acquista",back:"← Home",open:"Apri"},
pt:{home:"Início",games:"JOGOS",tarot:"TAROT & RITUAL",membership:"ADESÃO / LOGIN",profile:"PERFIL / XP",cashier:"CAIXA MONTENOIR",menu:"MENU",custom:"PERSONALIZAR PERFIL",settings:"DEFINIÇÕES",tournaments:"Torneios",chests:"Baús",achievements:"Conquistas",friends:"Amigos",ai:"Tarot IA Premium",rules:"Regras",language:"Idioma",theme:"Tema",notifications:"Notificações",privacy:"Privacidade",help:"Ajuda",buy:"Comprar",back:"← Início",open:"Abrir"},
nl:{home:"Home",games:"SPELLEN",tarot:"TAROT & RITUEEL",membership:"LIDMAATSCHAP / LOGIN",profile:"PROFIEL / XP",cashier:"MONTENOIR KASSA",menu:"MENU",custom:"PROFIEL AANPASSEN",settings:"INSTELLINGEN",tournaments:"Toernooien",chests:"Kisten",achievements:"Prestaties",friends:"Vrienden",ai:"Premium AI Tarot",rules:"Regels",language:"Taal",theme:"Thema",notifications:"Meldingen",privacy:"Privacy",help:"Hulp",buy:"Kopen",back:"← Home",open:"Openen"},
ro:{home:"Acasă",games:"JOCURI",tarot:"TAROT & RITUAL",membership:"ABONAMENT / LOGIN",profile:"PROFIL / XP",cashier:"CASIERIA MONTENOIR",menu:"MENU",custom:"PERSONALIZARE PROFIL",settings:"SETĂRI",tournaments:"Turnee",chests:"Cufere",achievements:"Realizări",friends:"Prieteni",ai:"Tarot AI Premium",rules:"Reguli",language:"Limbă",theme:"Temă",notifications:"Notificări",privacy:"Confidențialitate",help:"Ajutor",buy:"Cumpără",back:"← Acasă",open:"Deschide"},
ar:{home:"الرئيسية",games:"الألعاب",tarot:"التاروت والطقوس",membership:"العضوية / الدخول",profile:"الملف / XP",cashier:"خزينة مونتينوار",menu:"القائمة",custom:"تخصيص الملف",settings:"الإعدادات",tournaments:"البطولات",chests:"الصناديق",achievements:"الإنجازات",friends:"الأصدقاء",ai:"تاروت AI بريميوم",rules:"القواعد",language:"اللغة",theme:"المظهر",notifications:"الإشعارات",privacy:"الخصوصية",help:"المساعدة",buy:"شراء",back:"← الرئيسية",open:"فتح"},
ru:{home:"Главная",games:"ИГРЫ",tarot:"ТАРО И РИТУАЛ",membership:"ПОДПИСКА / ВХОД",profile:"ПРОФИЛЬ / XP",cashier:"КАССА MONTENOIR",menu:"МЕНЮ",custom:"НАСТРОЙКА ПРОФИЛЯ",settings:"НАСТРОЙКИ",tournaments:"Турниры",chests:"Сундуки",achievements:"Достижения",friends:"Друзья",ai:"Премиум AI Таро",rules:"Правила",language:"Язык",theme:"Тема",notifications:"Уведомления",privacy:"Конфиденциальность",help:"Помощь",buy:"Купить",back:"← Главная",open:"Открыть"}
};
function lang(){return localStorage.getItem("montenoirLang")||"tr"}
function applyI18n(){
 const l=lang(), d=T[l]||T.tr;
 document.documentElement.lang=l;
 document.documentElement.dir=(l==="ar")?"rtl":"ltr";
 const map=[
 ["🎮 OYUNLAR",d.games],["🔮 TAROT & RİTÜEL",d.tarot],["👤 ÜYELİK / GİRİŞ",d.membership],["🏆 PROFİL / XP",d.profile],
 ["🪙 MONTENOIR KASASI",d.cashier],["☰ MENU",d.menu],["🎨 PROFİL ÖZELLEŞTİRME",d.custom],["⚙️ AYARLAR",d.settings],
 ["← Ana sayfa",d.back],["Satın Al",d.buy],["Aç",d.open],["🎟️ Turnuvalar",d.tournaments],["🎁 Sandık Sistemi",d.chests],
 ["🏆 Başarımlar",d.achievements],["👥 Arkadaş Sistemi",d.friends],["🤖 AI Tarot Premium",d.ai],["🎨 Profil Özelleştirme",d.custom],
 ["⚙️ Ayarlar",d.settings],["🌍 Dil",d.language],["📜 Kurallar",d.rules],["🎨 Tema",d.theme],["🔔 Bildirimler",d.notifications],
 ["🔐 Gizlilik",d.privacy],["❓ Yardım",d.help]
 ];
 document.querySelectorAll("button,a,h1,h2,h3,p,div").forEach(el=>{
   if(el.children.length>0 && !el.classList.contains("royalBtn") && !el.classList.contains("btn")) return;
   let t=(el.textContent||"").trim();
   map.forEach(([a,b])=>{ if(t===a) el.textContent=b; });
 });
}
