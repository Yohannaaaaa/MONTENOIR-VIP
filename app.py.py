...
html,body{margin:0;width:100%;min-height:100%;font-family:Arial,Helvetica,sans-serif;background:#050505;color:#fff;overflow-x:hidden}
.home{
  position:relative;
  min-height:100vh;
  width:100%;
  background:
    linear-gradient(90deg,rgba(0,0,0,.22),rgba(0,0,0,.06) 35%,rgba(0,0,0,.06) 67%,rgba(0,0,0,.34)),
    linear-gradient(180deg,rgba(0,0,0,.18),rgba(0,0,0,.04) 48%,rgba(0,0,0,.32)),
    url('/static/montenoir_home.png') center top / 100% 100% no-repeat;
}
.topbar{
  position:absolute;top:0;left:0;right:0;z-index:20;
  height:96px;display:flex;align-items:center;
  padding:10px 30px;background:linear-gradient(180deg,rgba(0,0,0,.78),rgba(0,0,0,.20));
  border-bottom:1px solid rgba(212,175,55,.20)
}
.brand{
  width:210px;color:#d4af37;text-align:center;font-family:Georgia,serif;font-size:30px;font-weight:900;letter-spacing:2px;line-height:.9;
  text-shadow:0 0 16px rgba(212,175,55,.55)
}
.brand small{display:block;font-size:14px;letter-spacing:6px;margin-top:6px}
.nav{
  flex:1;display:flex;align-items:center;justify-content:center;height:100%;gap:0
}
.nav a,.nav button{
  height:96px;min-width:145px;padding:8px 16px;border:0;border-left:1px solid rgba(212,175,55,.22);
  background:transparent;color:#fff;text-decoration:none;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;
  font-size:15px;font-weight:900;letter-spacing:.4px;text-shadow:0 2px 6px #000;cursor:pointer
}
.nav a:last-child,.nav button:last-child{border-right:1px solid rgba(212,175,55,.22)}
.nav i{font-style:normal;font-size:32px;color:#d4af37;filter:drop-shadow(0 0 6px rgba(212,175,55,.55))}
.nav small{color:#d4af37;font-size:11px;margin-top:-5px}
.nav a:hover,.nav button:hover{background:rgba(212,175,55,.10);color:#f7d77a}
.userBlock{display:flex;align-items:center;gap:10px;margin-left:14px;min-width:165px;color:#fff;font-weight:900}
.userCircle{width:50px;height:50px;border-radius:50%;border:1px solid #d4af37;background:rgba(0,0,0,.55);display:grid;place-items:center;color:#d4af37}
.userBlock small{color:#d4af37;display:block;margin-top:4px}
.menuTop{
  margin-left:10px;width:118px;height:56px;border:1px solid #d4af37;border-radius:28px;background:rgba(0,0,0,.50);color:#d4af37;
  font-size:18px;font-weight:900;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:12px
}
.menuTop:hover{background:#d4af37;color:#050505}
.centerUI{
  position:absolute;z-index:10;left:50%;top:40%;transform:translate(-50%,-50%);
  width:min(420px,82vw);display:flex;flex-direction:column;align-items:center;text-align:center
}
.bigLogo{font-size:82px;color:#d4af37;text-shadow:0 0 22px rgba(212,175,55,.70);line-height:.7;margin-bottom:10px}
.mainTitle{
  font-family:Georgia,serif;font-size:clamp(54px,7vw,88px);font-weight:900;letter-spacing:4px;color:#d4af37;line-height:.9;
  text-shadow:0 0 22px rgba(212,175,55,.65)
}
.mainVip{font-family:Georgia,serif;font-size:38px;letter-spacing:12px;color:#f6d777;margin:10px 0 24px;text-shadow:0 0 12px #000}
.mainButtons{display:flex;flex-direction:column;gap:12px;width:100%;align-items:center}
.mainButtons button{
  width:360px;max-width:86vw;height:58px;border-radius:30px;border:1px solid #d4af37;
  font-size:22px;font-weight:900;letter-spacing:.4px;cursor:pointer;text-shadow:0 2px 4px #000;
  box-shadow:0 0 20px rgba(212,175,55,.35)
}
.playBtn{background:linear-gradient(180deg,#f8dfa0,#b68126);color:#fff}
.darkBtn{background:rgba(0,0,0,.60);color:#fff}
.mainButtons button:hover{transform:translateY(-2px);box-shadow:0 0 30px rgba(212,175,55,.65)}
.sidePanel{
  display:none;position:fixed;right:18px;top:104px;bottom:26px;z-index:80;
  width:min(380px,94vw);overflow:auto;border:1px solid rgba(212,175,55,.62);border-radius:12px;
  background:rgba(9,7,4,.88);backdrop-filter:blur(7px);box-shadow:0 0 40px rgba(0,0,0,.75)
}
.sidePanel.show{display:block}
.panelSection{padding:22px;border-bottom:1px solid rgba(212,175,55,.26)}
.panelTitle{color:#d4af37;font-size:23px;font-weight:900;margin-bottom:14px}
.panelLink{
  display:flex;align-items:center;gap:14px;color:#fff;text-decoration:none;font-weight:900;font-size:16px;
  min-height:56px;padding:12px 14px;border:1px solid rgba(212,175,55,.30);border-bottom:0;background:rgba(255,255,255,.04)
}
.panelLink:first-of-type{border-radius:8px 8px 0 0}
.panelLink:last-of-type{border-bottom:1px solid rgba(212,175,55,.30);border-radius:0 0 8px 8px}
.panelLink:hover{background:rgba(212,175,55,.14)}
.panelLink b{font-size:24px;color:#d4af37;min-width:28px}
.setting{
  border:1px solid rgba(212,175,55,.30);background:rgba(255,255,255,.04);border-radius:8px;padding:13px;margin-bottom:10px;color:#ddd
}
.setting h3{margin:0 0 8px;font-size:18px;color:#fff}
.setting p{margin:0;font-size:14px;line-height:1.35}
...
.bottomCards{
  position:absolute;left:28px;right:28px;bottom:22px;z-index:15;
  display:grid;grid-template-columns:repeat(4,1fr);gap:14px
}
.card{
  height:78px;border:1px solid rgba(212,175,55,.35);border-radius:12px;background:rgba(10,9,7,.80);
  display:flex;align-items:center;gap:14px;padding:12px 18px;box-shadow:0 0 18px rgba(0,0,0,.5)
}
.cardIcon{font-size:34px;color:#d4af37}
.cardText{font-size:15px;font-weight:900;color:#fff;line-height:1.1}
.cardText small{display:block;color:#d7c28a;font-size:12px;font-weight:500;margin-top:6px}
.card button{margin-left:auto;border:1px solid #d4af37;border-radius:18px;background:linear-gradient(180deg,#c5973d,#4b2f08);color:#fff;padding:8px 16px;font-weight:900;cursor:pointer}
...
.modalBox{width:min(460px,94vw);border:1px solid #d4af37;border-radius:18px;background:linear-gradient(145deg,#050505,#1b1205);box-shadow:0 0 40px rgba(212,175,55,.45);padding:22px;color:#f6d777}
.modalBox h2{text-align:center;color:#d4af37}
.modalBox input{width:100%;margin:7px 0;padding:12px;border-radius:12px;border:1px solid #d4af37;background:#090909;color:#fff}
.modalBox button{margin:5px;padding:10px 14px;border-radius:12px;border:1px solid #d4af37;background:#111;color:#f6d777;font-weight:bold;cursor:pointer}
.closeBtn{float:right}
.gamesPanel{display:none;position:fixed;z-index:90;left:50%;top:50%;transform:translate(-50%,-50%);width:min(560px,92vw);border:1px solid #d4af37;border-radius:14px;background:rgba(5,5,5,.90);padding:22px;box-shadow:0 0 35px rgba(0,0,0,.85)}
.gamesPanel.show{display:block}
.gameGrid{display:grid;grid-template-columns:repeat(2,1fr);gap:10px}
.gameGrid a{border:1px solid rgba(212,175,55,.35);border-radius:12px;padding:14px;color:#fff;text-decoration:none;font-weight:900;background:rgba(255,255,255,.04)}
.gameGrid a:hover{background:rgba(212,175,55,.16)}
@media(max-width:1100px){
  .nav{display:none}.userBlock{display:none}.topbar{justify-content:space-between}.brand{width:auto;font-size:22px}.bottomCards{display:none}
  .home{background-size:cover;background-position:center top}
  .centerUI{top:46%}
}
@media(max-width:640px){
  .mainTitle{font-size:48px}.bigLogo{font-size:62px}.mainVip{font-size:26px}.mainButtons button{height:52px;font-size:18px}
  .sidePanel{right:8px;top:88px}
}
</style>
</head>
<body>
