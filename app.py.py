...
.boardStage{
  position:relative;
  width:min(1340px,calc(100vw - 350px));
  aspect-ratio:16/10;
  display:flex;
  align-items:center;
  justify-content:center;
...
.boardWrap{
  ...
  width:100%;
  height:100%;
  transform:rotateX(3deg) rotateZ(-.5deg);
  transform-style:preserve-3d;
...
.diceCube{
  ...
  filter:drop-shadow(0 28px 20px rgba(0,0,0,.98)) drop-shadow(0 0 22px rgba(255,255,255,.22));
}
.face{
  position:absolute;
  width:118px;height:118px;
  border-radius:24px;
  background:linear-gradient(145deg,#fff,#e9e9e9 52%,#777);
  border:3px solid #fff;
  color:#1b0f00;
  display:grid;place-items:center;
  font-size:72px;font-weight:900;
  box-shadow:inset -15px -15px 24px rgba(0,0,0,.24),inset 10px 10px 18px rgba(255,255,255,.82);
}
...
@media(max-width:900px){
  ...
  .diceCube{width:82px;height:82px}
  .face{width:82px;height:82px;font-size:50px}
  .front{transform:translateZ(41px)}.back{transform:rotateY(180deg) translateZ(41px)}
  .right{transform:rotateY(90deg) translateZ(41px)}.left{transform:rotateY(-90deg) translateZ(41px)}
  .top{transform:rotateX(90deg) translateZ(41px)}.bottom{transform:rotateX(-90deg) translateZ(41px)}
}
</style>
</head>
<body>
...
const coords=[
[87,80],[78,80],[69,80],[60,80],[51,80],[42,80],[33,80],[24,80],[15,80],
[10,67],[10,56],[10,45],[10,34],[10,23],
[20,19],[30,19],[40,19],[50,19],[60,19],[70,19],[80,19],[89,19],
[90,32],[90,44],[90,56],[90,68],[90,79],
[80,79],[70,79],[60,79]
];
...
function render(st){
 ...
 logMsg(st.lastLog||"");
 if(st.lastDice){
   diceFace.textContent=faces[st.lastDice-1];
