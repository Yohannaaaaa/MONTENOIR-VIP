...
<button class="mainTopBtn" onclick="startTimer()">⏱ Süre</button>
<button class="mainTopBtn" onclick="newGame()">🎲 Yeni Oyun</button>
<button class="mainTopBtn" onclick="goLobby()">🚪 Lobi</button>
<button class="mainTopBtn closeTableBtn" onclick="closeCurrentTable()">❌ Masayı Kapat</button>
<button id="tarotTopBtn" class="tarotTopBtn" onclick="window.location.href='/tarot'">🚪 ✦ 🔮 TAROT & RITUEL ✦</button>
<div class="compactMenuWrap">
<button class="menuToggleBtn" onclick="toggleMainMenu(event)">☰ Menü</button>
<div id="mainCompactMenu" class="compactMenu">
<button onclick="openAuth();closeMainMenu()">👤 Üyelik</button>
<button onclick="openProfile();closeMainMenu()">🏆 Profil</button>
<button onclick="openRanking();closeMainMenu()">📊 Classement</button>
<button onclick="openSettings();closeMainMenu()">⚙️ Ayarlar</button>
<button onclick="openWords();closeMainMenu()">📚 Kelimeler</button>
<button onclick="openBet();closeMainMenu()">🎰 Bahis</button>
<button onclick="openShop();closeMainMenu()">🪙 Jeton Al</button>
<button id="ownerPanelBtn" style="display:none;" onclick="openOwnerPanel();closeMainMenu()">👑 Owner Panel</button>
</div>
</div>
</div>
...
function updateProfileChip(){
    if(currentAccount){
        ...
        profileChip.innerHTML='<img src="'+avatarSrc+'" style="width:36px;height:36px;border-radius:50%;object-fit:cover;border:'+imgBorder+';box-shadow:'+imgShadow+';"> <span class="'+genderCls+'">'+currentAccount+'</span>'+vip+' <span>🪙 '+(isOwner?'∞':currentChips)+'</span>';height:36px;border-radius:50%;object-fit:cover;border:'+imgBorder+';box-shadow:'+imgShadow+';"> <span class="'+genderCls+'">'+currentAccount+'</span>'+vip+' <span>🪙 '+currentChips+'</span>';
    }else{
