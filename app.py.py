...
setTimeout(function(){
 const map={
 '⚙️ Ayarlar':['⚙️ PARAMÈTRES','⚙️ SETTINGS','⚙️ AJUSTES','⚙️ EINSTELLUNGEN'],
 '📜 Kurallar':['📜 Règles','📜 Rules','📜 Reglas','📜 Regeln'],
 'Seçim tarayıcıda kaydedilir.':['Le choix est enregistré dans le navigateur.','The choice is saved in the browser.','La elección se guarda en el navegador.','Die Auswahl wird im Browser gespeichert.']
 };
},10);
