...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Londres Monopoly 3D</title>
<style>
*{box-sizing:border-box}
body{
  margin:0;
...
<script>
const cells=[
 ["Başlangıç",0,"gold"],["Sofia",100,"brown"],["Şans",0,"gold"],["Bucarest",140,"brown"],["Vergi",-100,"red"],["Belgrade",180,"sky"],
 ["Ziyaret",0,"gold"],["Varsovie",220,"sky"],["Sandık",0,"gold"],["Prague",260,"pink"],["Hapishane",0,"red"],["Budapest",300,"pink"],
 ["Ücretsiz Park",0,"gold"],["Lisbonne",340,"orange"],["Şans",0,"gold"],["Athènes",400,"orange"],["Lüks Vergi",-150,"red"],["Madrid",420,"red"],
 ["🚄 Gare Grande Vitesse",200,"yellow"],["Rome",460,"yellow"],["Berlin",500,"green"],["Moscou",550,"green"],["Londres",650,"blue"],["Final",0,"gold"]
];
...
function renderBoard(){
 ...
 cells.forEach((c,i)=>{
   ...
   div.className="cell";
   div.innerHTML='<div class="bar '+c[2]+'"></div><div class="name">'+c[0]+'</div>'+(c[1]>0?'<div class="price">'+c[1]+' $</div>':'')+(owned.includes(i)?'<div class="house">🏠</div>':'')+(i===pos?'<div class="token">'+playerToken+'</div>':'');
