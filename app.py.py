...
/* LIGHT MODE: only ZAR AT button at bottom */
.propertiesDock,
#propertiesDock,
.rollInfo,
#rollInfo,
...
.realDice{
  filter:drop-shadow(0 12px 10px rgba(0,0,0,.8))!important;
}
...
.realDice.rolling{animation:realDiceRollFixed .55s linear infinite!important}
...
function renderGroupStatus(st){}})}else{render(d.state)}},650)});
