...
.homeCenterButtons .mainGoldBtn{
  background:linear-gradient(180deg,#f4d27a 0%,#b77c25 48%,#734407 100%);
  border-color:rgba(255,220,135,.95);
  box-shadow:
    inset 0 1px 0 rgba(255,255,255,.35),
    inset 0 -8px 18px rgba(0,0,0,.20),
    0 0 30px rgba(212,175,55,.48);
}
.homeCenterButtons .mainDarkBtn{
  background:
    radial-gradient(circle at 50% 0%,rgba(212,175,55,.13),transparent 45%),
    linear-gradient(180deg,rgba(18,18,18,.95),rgba(3,3,3,.92));
}
.homeCenterButtons button:hover{
  transform:translateY(-2px);
  box-shadow:0 0 32px rgba(212,175,55,.62), inset 0 0 20px rgba(212,175,55,.08);
}
@media(max-width:900px){
  .homeCenterButtons{top:58%;width:min(340px,86vw)}
  .homeCenterButtons .mainGoldBtn,.homeCenterButtons .mainDarkBtn{height:52px;font-size:17px}
}
