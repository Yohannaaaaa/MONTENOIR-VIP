...
(function(){
const M={
tr:{"⚙️ Ayarlar":"⚙️ Ayarlar","📜 Kurallar":"📜 Kurallar","Seçim tarayıcıda kaydedilir.":"Seçim tarayıcıda kaydedilir.","🌍 Dil":"🌍 Dil","🎨 Tema":"🎨 Tema","🔔 Bildirimler":"🔔 Bildirimler","🔐 Gizlilik":"🔐 Gizlilik","❓ Yardım":"❓ Yardım","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Saygılı oyun, hile yasak, uygunsuz davranış yasak.","Siyah & altın MONTENOIR teması aktif.":"Siyah & altın MONTENOIR teması aktif.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Turnuva, sandık ve özel mesaj bildirimleri yakında.","Email diğer oyunculara gösterilmez.":"Email diğer oyunculara gösterilmez.","Oyun kuralları ve destek bölümü yakında.":"Oyun kuralları ve destek bölümü yakında."},
fr:{"⚙️ Ayarlar":"⚙️ Paramètres","📜 Kurallar":"📜 Règles","Seçim tarayıcıda kaydedilir.":"Le choix est enregistré dans le navigateur.","🌍 Dil":"🌍 Langue","🎨 Tema":"🎨 Thème","🔔 Bildirimler":"🔔 Notifications","🔐 Gizlilik":"🔐 Confidentialité","❓ Yardım":"❓ Aide","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Jeu respectueux, triche interdite, comportement abusif interdit.","Siyah & altın MONTENOIR teması aktif.":"Le thème noir et or MONTENOIR est actif.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notifications de tournois, coffres et messages privés bientôt.","Email diğer oyunculara gösterilmez.":"L’e-mail n’est pas affiché aux autres joueurs.","Oyun kuralları ve destek bölümü yakında.":"Règles de jeu et support bientôt disponibles."},
en:{"⚙️ Ayarlar":"⚙️ Settings","📜 Kurallar":"📜 Rules","Seçim tarayıcıda kaydedilir.":"The choice is saved in the browser.","🌍 Dil":"🌍 Language","🎨 Tema":"🎨 Theme","🔔 Bildirimler":"🔔 Notifications","🔐 Gizlilik":"🔐 Privacy","❓ Yardım":"❓ Help","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Respectful play, no cheating, no abusive behavior.","Siyah & altın MONTENOIR teması aktif.":"The black and gold MONTENOIR theme is active.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Tournament, chest and private message notifications coming soon.","Email diğer oyunculara gösterilmez.":"Email is not shown to other players.","Oyun kuralları ve destek bölümü yakında.":"Game rules and support coming soon."},
es:{"⚙️ Ayarlar":"⚙️ Ajustes","📜 Kurallar":"📜 Reglas","Seçim tarayıcıda kaydedilir.":"La elección se guarda en el navegador.","🌍 Dil":"🌍 Idioma","🎨 Tema":"🎨 Tema","🔔 Bildirimler":"🔔 Notificaciones","🔐 Gizlilik":"🔐 Privacidad","❓ Yardım":"❓ Ayuda","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Juego respetuoso, trampas prohibidas, comportamiento abusivo prohibido.","Siyah & altın MONTENOIR teması aktif.":"El tema negro y dorado MONTENOIR está activo.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notificaciones de torneos, cofres y mensajes privados próximamente.","Email diğer oyunculara gösterilmez.":"El email no se muestra a otros jugadores.","Oyun kuralları ve destek bölümü yakında.":"Reglas del juego y soporte próximamente."},
de:{"⚙️ Ayarlar":"⚙️ Einstellungen","📜 Kurallar":"📜 Regeln","Seçim tarayıcıda kaydedilir.":"Die Auswahl wird im Browser gespeichert.","🌍 Dil":"🌍 Sprache","🎨 Tema":"🎨 Thema","🔔 Bildirimler":"🔔 Benachrichtigungen","🔐 Gizlilik":"🔐 Datenschutz","❓ Yardım":"❓ Hilfe","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Respektvolles Spielen, Betrug verboten, beleidigendes Verhalten verboten.","Siyah & altın MONTENOIR teması aktif.":"Das schwarz-goldene MONTENOIR-Theme ist aktiv.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Turnier-, Truhen- und Privatnachrichten-Benachrichtigungen kommen bald.","Email diğer oyunculara gösterilmez.":"Die E-Mail wird anderen Spielern nicht angezeigt.","Oyun kuralları ve destek bölümü yakında.":"Spielregeln und Support folgen bald."},
it:{"⚙️ Ayarlar":"⚙️ Impostazioni","📜 Kurallar":"📜 Regole","Seçim tarayıcıda kaydedilir.":"La scelta viene salvata nel browser.","🌍 Dil":"🌍 Lingua","🎨 Tema":"🎨 Tema","🔔 Bildirimler":"🔔 Notifiche","🔐 Gizlilik":"🔐 Privacy","❓ Yardım":"❓ Aiuto","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Gioco rispettoso, trucchi vietati, comportamento abusivo vietato.","Siyah & altın MONTENOIR teması aktif.":"Il tema nero e oro MONTENOIR è attivo.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notifiche per tornei, forzieri e messaggi privati presto disponibili.","Email diğer oyunculara gösterilmez.":"L’email non viene mostrata agli altri giocatori.","Oyun kuralları ve destek bölümü yakında.":"Regole del gioco e supporto presto disponibili."},
pt:{"⚙️ Ayarlar":"⚙️ Definições","📜 Kurallar":"📜 Regras","Seçim tarayıcıda kaydedilir.":"A escolha é guardada no navegador.","🌍 Dil":"🌍 Idioma","🎨 Tema":"🎨 Tema","🔔 Bildirimler":"🔔 Notificações","🔐 Gizlilik":"🔐 Privacidade","❓ Yardım":"❓ Ajuda","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Jogo respeitoso, batota proibida, comportamento abusivo proibido.","Siyah & altın MONTENOIR teması aktif.":"O tema preto e dourado MONTENOIR está ativo.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notificações de torneios, baús e mensagens privadas em breve.","Email diğer oyunculara gösterilmez.":"O email não é mostrado a outros jogadores.","Oyun kuralları ve destek bölümü yakında.":"Regras do jogo e suporte em breve."},
nl:{"⚙️ Ayarlar":"⚙️ Instellingen","📜 Kurallar":"📜 Regels","Seçim tarayıcıda kaydedilir.":"De keuze wordt opgeslagen in de browser.","🌍 Dil":"🌍 Taal","🎨 Tema":"🎨 Thema","🔔 Bildirimler":"🔔 Meldingen","🔐 Gizlilik":"🔐 Privacy","❓ Yardım":"❓ Hulp","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Respectvol spelen, vals spelen verboden, beledigend gedrag verboden.","Siyah & altın MONTENOIR teması aktif.":"Het zwart-gouden MONTENOIR-thema is actief.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Meldingen voor toernooien, kisten en privéberichten komen binnenkort.","Email diğer oyunculara gösterilmez.":"E-mail wordt niet getoond aan andere spelers.","Oyun kuralları ve destek bölümü yakında.":"Spelregels en ondersteuning binnenkort beschikbaar."},
ro:{"⚙️ Ayarlar":"⚙️ Setări","📜 Kurallar":"📜 Reguli","Seçim tarayıcıda kaydedilir.":"Alegerea este salvată în browser.","🌍 Dil":"🌍 Limbă","🎨 Tema":"🎨 Temă","🔔 Bildirimler":"🔔 Notificări","🔐 Gizlilik":"🔐 Confidențialitate","❓ Yardım":"❓ Ajutor","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Joc respectuos, trișatul este interzis, comportamentul abuziv este interzis.","Siyah & altın MONTENOIR teması aktif.":"Tema negru și auriu MONTENOIR este activă.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Notificările pentru turnee, cufere și mesaje private vin curând.","Email diğer oyunculara gösterilmez.":"Emailul nu este afișat altor jucători.","Oyun kuralları ve destek bölümü yakında.":"Regulile jocului și suportul vor fi disponibile curând."},
ar:{"⚙️ Ayarlar":"⚙️ الإعدادات","📜 Kurallar":"📜 القواعد","Seçim tarayıcıda kaydedilir.":"يتم حفظ الاختيار في المتصفح.","🌍 Dil":"🌍 اللغة","🎨 Tema":"🎨 المظهر","🔔 Bildirimler":"🔔 الإشعارات","🔐 Gizlilik":"🔐 الخصوصية","❓ Yardım":"❓ المساعدة","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"اللعب باحترام، الغش ممنوع، والسلوك المسيء ممنوع.","Siyah & altın MONTENOIR teması aktif.":"سمة MONTENOIR السوداء والذهبية مفعلة.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"إشعارات البطولات والصناديق والرسائل الخاصة قريباً.","Email diğer oyunculara gösterilmez.":"لا يتم عرض البريد الإلكتروني للاعبين الآخرين.","Oyun kuralları ve destek bölümü yakında.":"قواعد الألعاب والدعم قريباً."},
ru:{"⚙️ Ayarlar":"⚙️ Настройки","📜 Kurallar":"📜 Правила","Seçim tarayıcıda kaydedilir.":"Выбор сохраняется в браузере.","🌍 Dil":"🌍 Язык","🎨 Tema":"🎨 Тема","🔔 Bildirimler":"🔔 Уведомления","🔐 Gizlilik":"🔐 Конфиденциальность","❓ Yardım":"❓ Помощь","Saygılı oyun, hile yasak, uygunsuz davranış yasak.":"Уважительная игра, мошенничество запрещено, оскорбительное поведение запрещено.","Siyah & altın MONTENOIR teması aktif.":"Чёрно-золотая тема MONTENOIR активна.","Turnuva, sandık ve özel mesaj bildirimleri yakında.":"Уведомления о турнирах, сундуках и личных сообщениях скоро.","Email diğer oyunculara gösterilmez.":"Email не показывается другим игрокам.","Oyun kuralları ve destek bölümü yakında.":"Правила игр и поддержка скоро будут доступны."}
};
function applyAllLangs(){
 const lang=localStorage.getItem("montenoirLang")||"tr", d=M[lang]||M.tr;
 ...
 document.querySelectorAll("h1,h2,h3,p,div,span,button,a").forEach(el=>{
   ...
   Object.keys(M.tr).forEach(k=>{
     if(s===k || Object.values(M).some(dict=>dict[k]===s)) el.textContent=d[k];
   });
 });
}
document.addEventListener("DOMContentLoaded",applyAllLangs);
setTimeout(applyAllLangs,300);
setTimeout(applyAllLangs,1000);
const old=window.setMontenoirLang;
window.setMontenoirLang=function(v){
 localStorage.setItem("montenoirLang",v);
 if(old) old(v);
 setTimeout(applyAllLangs,50);
 setTimeout(applyAllLangs,500);
};
})();
...
(function(){
const BTN={
tr:{"Satın Al":"Satın Al","Aç":"Aç","Katıl":"Katıl","Arkadaş Ekle":"Arkadaş Ekle","Özel Mesaj Gönder":"Özel Mesaj Gönder","Kabul Et":"Kabul Et","Premium Yorumu Al":"Premium Yorumu Al","Kasaya Git":"Kasaya Git","Tarot sayfasına git":"Tarot sayfasına git"},
fr:{"Satın Al":"Acheter","Aç":"Ouvrir","Katıl":"Participer","Arkadaş Ekle":"Ajouter un ami","Özel Mesaj Gönder":"Envoyer un message privé","Kabul Et":"Accepter","Premium Yorumu Al":"Recevoir l’interprétation premium","Kasaya Git":"Aller à la caisse","Tarot sayfasına git":"Aller au tarot"},
en:{"Satın Al":"Buy","Aç":"Open","Katıl":"Join","Arkadaş Ekle":"Add friend","Özel Mesaj Gönder":"Send private message","Kabul Et":"Accept","Premium Yorumu Al":"Get premium reading","Kasaya Git":"Go to cashier","Tarot sayfasına git":"Go to tarot"},
es:{"Satın Al":"Comprar","Aç":"Abrir","Katıl":"Unirse","Arkadaş Ekle":"Añadir amigo","Özel Mesaj Gönder":"Enviar mensaje privado","Kabul Et":"Aceptar","Premium Yorumu Al":"Obtener lectura premium","Kasaya Git":"Ir a la caja","Tarot sayfasına git":"Ir al tarot"},
de:{"Satın Al":"Kaufen","Aç":"Öffnen","Katıl":"Teilnehmen","Arkadaş Ekle":"Freund hinzufügen","Özel Mesaj Gönder":"Private Nachricht senden","Kabul Et":"Akzeptieren","Premium Yorumu Al":"Premium-Deutung erhalten","Kasaya Git":"Zur Kasse","Tarot sayfasına git":"Zum Tarot"},
it:{"Satın Al":"Acquista","Aç":"Apri","Katıl":"Partecipa","Arkadaş Ekle":"Aggiungi amico","Özel Mesaj Gönder":"Invia messaggio privato","Kabul Et":"Accetta","Premium Yorumu Al":"Ottieni lettura premium","Kasaya Git":"Vai alla cassa","Tarot sayfasına git":"Vai ai tarocchi"},
pt:{"Satın Al":"Comprar","Aç":"Abrir","Katıl":"Participar","Arkadaş Ekle":"Adicionar amigo","Özel Mesaj Gönder":"Enviar mensagem privada","Kabul Et":"Aceitar","Premium Yorumu Al":"Obter leitura premium","Kasaya Git":"Ir para a caixa","Tarot sayfasına git":"Ir para o tarot"},
nl:{"Satın Al":"Kopen","Aç":"Openen","Katıl":"Meedoen","Arkadaş Ekle":"Vriend toevoegen","Özel Mesaj Gönder":"Privébericht sturen","Kabul Et":"Accepteren","Premium Yorumu Al":"Premium reading krijgen","Kasaya Git":"Naar kassa","Tarot sayfasına git":"Naar tarot"},
ro:{"Satın Al":"Cumpără","Aç":"Deschide","Katıl":"Participă","Arkadaş Ekle":"Adaugă prieten","Özel Mesaj Gönder":"Trimite mesaj privat","Kabul Et":"Acceptă","Premium Yorumu Al":"Primește interpretarea premium","Kasaya Git":"Mergi la casierie","Tarot sayfasına git":"Mergi la tarot"},
ar:{"Satın Al":"شراء","Aç":"فتح","Katıl":"انضمام","Arkadaş Ekle":"إضافة صديق","Özel Mesaj Gönder":"إرسال رسالة خاصة","Kabul Et":"قبول","Premium Yorumu Al":"الحصول على قراءة بريميوم","Kasaya Git":"اذهب إلى الخزينة","Tarot sayfasına git":"اذهب إلى التاروت"},
ru:{"Satın Al":"Купить","Aç":"Открыть","Katıl":"Участвовать","Arkadaş Ekle":"Добавить друга","Özel Mesaj Gönder":"Отправить личное сообщение","Kabul Et":"Принять","Premium Yorumu Al":"Получить премиум-расклад","Kasaya Git":"В кассу","Tarot sayfasına git":"Перейти к таро"}
};
function baseKey(text){
 text=(text||"").trim();
 for(const lang of Object.keys(BTN)){
   for(const [k,v] of Object.entries(BTN[lang])){
     if(text===k || text===v) return k;
   }
 }
 return null;
}
function translateButtons(){
 ...
 const dict=BTN[lang]||BTN.tr;
 document.querySelectorAll("button,a.btn,a.gameItem").forEach(el=>{
   let raw=el.getAttribute("data-base-label") || baseKey(el.textContent);
   if(raw && dict[raw]){
     el.setAttribute("data-base-label",raw);
     el.textContent=dict[raw];
   }
 });
}
document.addEventListener("DOMContentLoaded",translateButtons);
setTimeout(translateButtons,200);
setTimeout(translateButtons,800);
setTimeout(translateButtons,1600);
const prev=window.setMontenoirLang;
window.setMontenoirLang=function(v){
 localStorage.setItem("montenoirLang",v);
 if(prev) prev(v);
 setTimeout(translateButtons,50);
 setTimeout(translateButtons,400);
...
<title>🏛️ MONTENOIR VIP</title>
<script src="https://cdn.socket.io/4.7.5/socket.io.min.js"></script>
<style>
*{box-sizing:border-box}
body{margin:0;min-height:100vh;overflow-x:hidden;font-family:Arial,Helvetica,sans-serif;color:#f7df9a;background:#050505}
.hero{position:relative;min-height:100vh;width:100%;background:linear-gradient(90deg,rgba(0,0,0,.72),rgba(0,0,0,.2) 36%,rgba(0,0,0,.22) 64%,rgba(0,0,0,.76)),linear-gradient(180deg,rgba(0,0,0,.76),rgba(0,0,0,.18) 48%,rgba(0,0,0,.88)),url("/static/montenoir_home.png") center center/cover no-repeat}
.topbar{position:relative;z-index:20;height:96px;display:flex;align-items:center;padding:10px 34px;border-bottom:1px solid rgba(212,175,55,.20);background:linear-gradient(180deg,rgba(0,0,0,.84),rgba(0,0,0,.34));backdrop-filter:blur(4px)}
.brand{width:210px;text-align:center;color:#d4af37;font-family:Georgia,serif;font-weight:900;letter-spacing:2px;font-size:28px;line-height:.9;text-shadow:0 0 16px rgba(212,175,55,.55)}
.brand small{display:block;font-size:14px;letter-spacing:6px;margin-top:5px}
.nav{flex:1;display:flex;align-items:center;justify-content:center;gap:22px}
.navBtn{min-width:124px;height:76px;border:0;border-left:1px solid rgba(212,175,55,.20);background:transparent;color:#fff;font-weight:800;letter-spacing:.5px;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;text-decoration:none;font-size:14px;text-shadow:0 0 7px #000}
.navBtn span{font-size:29px;color:#d4af37;filter:drop-shadow(0 0 6px rgba(212,175,55,.6))}
.navBtn:hover{background:rgba(212,175,55,.08);color:#ffd978}
.userMini{display:flex;align-items:center;gap:10px;min-width:170px;justify-content:flex-end;color:#fff}
.userAvatar{width:48px;height:48px;border-radius:50%;border:1px solid #d4af37;background:rgba(0,0,0,.7);display:grid;place-items:center}
.userVip{color:#d4af37;font-weight:900;font-size:13px}
.menuBtn{margin-left:18px;width:90px;height:56px;border:1px solid #d4af37;border-radius:28px;background:rgba(0,0,0,.55);color:#d4af37;font-weight:900;font-size:17px;cursor:pointer;box-shadow:0 0 16px rgba(212,175,55,.22)}
.menuBtn:hover{background:#d4af37;color:#000}
.center{position:relative;z-index:10;min-height:calc(100vh - 96px);display:flex;align-items:center;justify-content:center;text-align:center;padding:40px 20px 130px}
.logoMark{font-size:105px;color:#d4af37;text-shadow:0 0 24px rgba(212,175,55,.62);line-height:.8}
.title{font-family:Georgia,serif;font-size:clamp(54px,7vw,96px);letter-spacing:4px;color:#d4af37;text-shadow:0 0 20px rgba(212,175,55,.62);margin:12px 0 0}
.vip{font-family:Georgia,serif;font-size:38px;letter-spacing:12px;color:#f6d777;margin:0 0 24px}
.mainBtns{display:flex;flex-direction:column;gap:12px;align-items:center}
.goldBtn,.darkBtn{width:min(360px,82vw);height:58px;border-radius:30px;font-size:22px;font-weight:900;letter-spacing:.5px;cursor:pointer;border:1px solid #d4af37;box-shadow:0 0 18px rgba(212,175,55,.35);transition:.15s}
.goldBtn{background:linear-gradient(180deg,#f8dfa0,#b98528);color:#fff;text-shadow:0 1px 2px #000}
.darkBtn{background:rgba(0,0,0,.62);color:#fff}
.goldBtn:hover,.darkBtn:hover{transform:translateY(-2px);box-shadow:0 0 28px rgba(212,175,55,.65)}
.drawerOverlay{display:none;position:fixed;inset:0;z-index:90;background:rgba(0,0,0,.35)}
.drawer{position:fixed;right:26px;top:104px;bottom:28px;width:min(380px,92vw);z-index:100;display:none;border:1px solid rgba(212,175,55,.62);border-radius:12px;background:rgba(7,6,4,.88);backdrop-filter:blur(7px);box-shadow:0 0 45px rgba(0,0,0,.75), inset 0 0 30px rgba(212,175,55,.08);overflow:auto}
.drawer.show,.drawerOverlay.show{display:block}
.drawerSection{padding:24px;border-bottom:1px solid rgba(212,175,55,.26)}
.drawerTitle{font-size:22px;font-weight:900;color:#d4af37;margin-bottom:14px;text-align:left}
.drawerItem{display:flex;align-items:center;gap:14px;width:100%;min-height:58px;padding:12px 14px;margin:0;color:#fff;text-decoration:none;border:1px solid rgba(212,175,55,.24);border-bottom:0;background:rgba(255,255,255,.04);font-weight:800;text-align:left;cursor:pointer}
.drawerItem:first-of-type{border-radius:8px 8px 0 0}
.drawerItem:last-of-type{border-bottom:1px solid rgba(212,175,55,.24);border-radius:0 0 8px 8px}
.drawerItem:hover{background:rgba(212,175,55,.14)}
.drawerItem b{font-size:24px;color:#d4af37;min-width:30px;text-align:center}
.settingBox{border:1px solid rgba(212,175,55,.24);background:rgba(255,255,255,.035);padding:14px;margin-bottom:10px;border-radius:8px;text-align:left;color:#eee}
.settingBox h3{margin:0 0 8px;color:#fff;font-size:18px}
.settingBox p{margin:0;color:#ddd;line-height:1.35}
.settingBox select{background:#101010;color:#f6d777;border:1px solid #d4af37;border-radius:10px;padding:9px;margin-top:7px;width:100%}
.bottomCards{position:absolute;left:24px;right:24px;bottom:24px;z-index:15;display:grid;grid-template-columns:repeat(4,1fr);gap:14px}
.infoCard{min-height:78px;border:1px solid rgba(212,175,55,.35);border-radius:12px;background:rgba(10,9,7,.78);display:flex;align-items:center;gap:14px;padding:12px 18px;box-shadow:0 0 18px rgba(0,0,0,.45)}
.infoIcon{font-size:34px;color:#d4af37}
.infoText{text-align:left;color:#fff;font-weight:800}
.infoText small{display:block;color:#d7c28a;font-size:12px;margin-top:6px;font-weight:500}
.infoCard button{margin-left:auto;border:1px solid #d4af37;border-radius:18px;background:linear-gradient(180deg,#c5973d,#4b2f08);color:#fff;padding:8px 16px;font-weight:800;cursor:pointer}
...
.modalContent{width:min(460px,94vw);border:1px solid #d4af37;border-radius:18px;background:linear-gradient(145deg,#050505,#1d1405);box-shadow:0 0 45px rgba(212,175,55,.45);padding:22px;color:#f6d777;text-align:left}
.modalContent h2{text-align:center;color:#d4af37}
.modalContent input{width:100%;margin:7px 0;padding:12px;border-radius:12px;border:1px solid #d4af37;background:#090909;color:#fff}
.modalContent button{margin:5px;padding:10px 14px;border-radius:12px;border:1px solid #d4af37;background:#111;color:#f6d777;font-weight:bold;cursor:pointer}
.closeHome{float:right}
.homeStatus{font-size:13px;color:#fff;margin-top:10px}
@media(max-width:1050px){.nav{display:none}.userMini{display:none}.brand{width:auto;font-size:22px}.topbar{justify-content:space-between}.bottomCards{display:none}.center{padding-bottom:40px}.drawer{right:10px;top:90px}}
@media(max-width:640px){.logoMark{font-size:72px}.title{font-size:48px}.vip{font-size:26px}.goldBtn,.darkBtn{height:52px;font-size:18px}}
</style>
</head>
<body>
<div class="hero">
<header class="topbar">
<div class="brand">MONTENOIR<small>VIP</small></div>
<nav class="nav">
<a class="navBtn" href="/tarot"><span>🃏</span>TAROT & RİTÜEL</a>
<a class="navBtn" href="/turnuvalar"><span>🏆</span>TURNUVALAR</a>
<a class="navBtn" href="/ai-tarot-premium"><span>💎</span>AI TAROT<br><small>PREMIUM</small></a>
<a class="navBtn" href="/arkadaslar"><span>👥</span>ARKADAŞLAR</a>
<button class="navBtn" onclick="openSettingsOnly()"><span>⚙️</span>AYARLAR</button>
</nav>
<div class="userMini"><div class="userAvatar">👤</div><div><b id="miniUser">Montenoir VIP</b><div class="userVip">VIP ♛</div></div></div>
<button class="menuBtn" onclick="toggleDrawer()">☰ MENÜ</button>
</header>
<main class="center"><div><div class="logoMark">♛</div><h1 class="title">MONTENOIR</h1><div class="vip">VIP</div><div class="mainBtns"><button class="goldBtn" onclick="toggleGames()">OYUNLAR</button><button class="darkBtn" onclick="openAuthHome()">👤 ÜYELİK / GİRİŞ</button><button class="darkBtn" onclick="location.href='/premium'">💎 PREMIUM ÜYELİK</button></div></div></main>
<section id="gamesPanel" class="drawer" style="left:50%;right:auto;transform:translateX(-50%);top:56%;bottom:auto;width:min(560px,92vw)"><div class="drawerSection"><div class="drawerTitle">🎮 OYUNLAR</div><a class="drawerItem" href="/codenames"><b>👑</b>Codenames VIP</a><a class="drawerItem" href="/coming-soon/Poker"><b>♠️</b>Poker</a><a class="drawerItem" href="/coming-soon/Tavla"><b>🎲</b>Tavla</a><a class="drawerItem" href="/coming-soon/Okey"><b>🀄</b>Okey</a><a class="drawerItem" href="/coming-soon/101"><b>💎</b>101</a><a class="drawerItem" href="/coming-soon/Monopoly"><b>🏙️</b>Monopoly</a><a class="drawerItem" href="/coming-soon/Ludo"><b>🔴</b>Ludo</a><a class="drawerItem" href="/coming-soon/Bowling"><b>🎳</b>Bowling</a></div></section>
<div id="drawerOverlay" class="drawerOverlay" onclick="closeDrawer()"></div>
<aside id="sideDrawer" class="drawer">
<div class="drawerSection" id="menuSection"><div class="drawerTitle">MENÜ</div><a class="drawerItem" href="/kasa"><b>🪙</b>MONTENOIR KASASI</a><a class="drawerItem" href="/oyun-kurallari"><b>📜</b>OYUN KURALLARI</a><a class="drawerItem" href="/sandiklar"><b>🎁</b>SANDIK SİSTEMİ</a><a class="drawerItem" href="/profil-magazasi"><b>🎨</b>PROFİL ÖZELLEŞTİRME</a><a class="drawerItem" href="#" onclick="openProfileHome();return false;"><b>🏆</b>PROFİL / XP</a></div>
<div class="drawerSection" id="settingsSection"><div class="drawerTitle">AYARLAR</div>
<div class="settingBox"><h3>🌍 Dil</h3><select id="montenoirLangSelect" onchange="setMontenoirLang(this.value)"><option value="tr">🇹🇷 Türkçe</option><option value="fr">🇫🇷 Français</option><option value="en">🇬🇧 English</option><option value="es">🇪🇸 Español</option><option value="de">🇩🇪 Deutsch</option><option value="it">🇮🇹 Italiano</option><option value="pt">🇵🇹 Português</option><option value="nl">🇳🇱 Nederlands</option><option value="ro">🇷🇴 Română</option><option value="ar">🇸🇦 العربية</option><option value="ru">🇷🇺 Русский</option></select></div>
<div class="settingBox"><h3>📜 Kurallar</h3><p>Saygılı oyun, hile yasak, uygunsuz davranış yasak.</p></div>
<div class="settingBox"><h3>🎨 Tema</h3><p>Siyah & altın MONTENOIR teması aktif.</p></div>
<div class="settingBox"><h3>🔔 Bildirimler</h3><p>Turnuva, sandık ve özel mesaj ve davet bildirimleri yakında.</p></div>
<div class="settingBox"><h3>🔐 Gizlilik</h3><p>Email diğer oyunculara gösterilmez.</p></div>
<div class="settingBox"><h3>❓ Yardım</h3><p>Oyun kuralları ve destek bölümü yakında.</p></div>
</div></aside>
<section class="bottomCards"><div class="infoCard"><div class="infoIcon">🎁</div><div class="infoText">GÜNLÜK ÖDÜL<small>Hediyeni almayı unutma!</small></div><button>AL</button></div><div class="infoCard"><div class="infoIcon">🏆</div><div class="infoText">AKTİF TURNUVA<small>Haftalık Codenames Turnuvası</small></div><button onclick="location.href='/turnuvalar'">KATIL</button></div><div class="infoCard"><div class="infoIcon">⭐</div><div class="infoText">VIP PUANIN<small id="vipScore">12.450</small></div><button onclick="openProfileHome()">DETAYLAR</button></div><div class="infoCard"><div class="infoIcon">👥</div><div class="infoText">ARKADAŞLAR<small>32 Çevrimiçi</small></div><button onclick="location.href='/arkadaslar'">GÖRÜNTÜLE</button></div></section>
</div>
<div id="homeAuthModal" class="modal"><div class="modalContent"><button class="closeHome" onclick="closeHomeModals()">X</button><h2>👤 Üyelik</h2><h3>📝 Kayıt Ol</h3><input id="hRegUsername" placeholder="Kullanıcı adı"><input id="hRegEmail" type="email" placeholder="Email"><input id="hRegPassword" type="password" placeholder="Şifre"><input id="hRegPassword2" type="password" placeholder="Şifre tekrar"><button onclick="homeRegister()">Kayıt Ol</button><hr><h3>🔐 Giriş Yap</h3><input id="hLoginUsername" placeholder="Kullanıcı adı"><input id="hLoginPassword" type="password" placeholder="Şifre"><button onclick="homeLogin()">Giriş Yap</button><button onclick="homeLogout()">Çıkış Yap</button><div id="homeAuthStatus" class="homeStatus">Henüz giriş yapılmadı.</div></div></div>
<div id="homeProfileModal" class="modal"><div class="modalContent"><button class="closeHome" onclick="closeHomeModals()">X</button><h2>🏆 Profil / XP</h2><div id="homeProfileBox" class="homeStatus">Giriş yapmadın.</div><button onclick="location.href='/codenames'">🎮 Codenames VIP’e Git</button></div></div>
<script>
const homeSocket=io();let homeProfile=null;
function toggleDrawer(){sideDrawer.classList.toggle('show');drawerOverlay.classList.toggle('show');gamesPanel.classList.remove('show')}
function closeDrawer(){sideDrawer.classList.remove('show');drawerOverlay.classList.remove('show');gamesPanel.classList.remove('show')}
function toggleGames(){gamesPanel.classList.toggle('show');sideDrawer.classList.remove('show');drawerOverlay.classList.remove('show')}
function openSettingsOnly(){sideDrawer.classList.add('show');drawerOverlay.classList.add('show');gamesPanel.classList.remove('show');setTimeout(()=>settingsSection.scrollIntoView({behavior:'smooth'}),80)}
function closeHomeModals(){homeAuthModal.style.display='none';homeProfileModal.style.display='none'}
function openAuthHome(){homeAuthModal.style.display='flex';homeAuthStatus.innerHTML=localStorage.getItem('codenamesAccount')?'Connecté : '+localStorage.getItem('codenamesAccount'):'Henüz giriş yapılmadı.'}
function openProfileHome(){homeProfileModal.style.display='flex';let a=localStorage.getItem('codenamesAccount');if(a){homeSocket.emit('request_profile',{account:a});homeProfileBox.innerHTML='Profil yükleniyor...'}else{homeProfileBox.innerHTML='Giriş yapmadın. Önce üyelik/giriş yap.'}}
function homeXP(p){return ((p.wins||0)*100)+((p.games||0)*10)}
function renderHomeProfile(p){homeProfile=p;localStorage.setItem('codenamesAccount',p.username);localStorage.setItem('loggedUser',p.username);localStorage.setItem('loggedIn','true');localStorage.setItem('codenamesProfile',JSON.stringify(p));miniUser.innerText=p.username;homeProfileBox.innerHTML='<div><b>👤 '+p.username+'</b><br>⭐ Seviye: '+(p.level||1)+'<br>🏆 XP: '+(p.xp||homeXP(p))+'<br>🪙 Jeton: '+(p.chips||0)+'<br>🎖️ Rozet: '+(p.membershipLabel||'Yok')+'</div>'}
function homeRegister(){let u=hRegUsername.value.trim(),e=hRegEmail.value.trim(),p=hRegPassword.value,p2=hRegPassword2.value;if(!u||!e||!p||!p2){alert('Tüm alanları doldur.');return}if(p!==p2){alert('Şifreler aynı değil.');return}homeSocket.emit('register_account',{username:u,email:e,password:p,avatar:'woman.png'})}
function homeLogin(){let u=hLoginUsername.value.trim(),p=hLoginPassword.value;if(!u||!p){alert('Kullanıcı adı ve şifre yaz.');return}homeSocket.emit('login_account',{username:u,password:p})}
function homeLogout(){localStorage.removeItem('codenamesAccount');localStorage.removeItem('loggedUser');localStorage.removeItem('loggedIn');localStorage.removeItem('codenamesProfile');homeAuthStatus.innerHTML='Çıkış yapıldı.';miniUser.innerText='Montenoir VIP'}
homeSocket.on('register_result',d=>{homeAuthStatus.innerHTML=d.msg||JSON.stringify(d);if(d.ok&&d.profile)renderHomeProfile(d.profile);});
homeSocket.on('login_result',d=>{homeAuthStatus.innerHTML=d.msg||JSON.stringify(d);if(d.ok&&d.profile)renderHomeProfile(d.profile);});
homeSocket.on('profile_data',d=>{if(d.profile)renderHomeProfile(d.profile);});
homeSocket.on('profile_loaded',d=>{if(d.profile)renderHomeProfile(d.profile);});
setTimeout(()=>{let p=localStorage.getItem('codenamesProfile');if(p){try{renderHomeProfile(JSON.parse(p))}catch(e){}}},200);
</script>
</body>
</html>
"""
...
<div class="pack"><h2>VIP</h2><div class="price">🪙 3.000</div><p>39,99 €</p><button data-base-label='Satın Al' class="btn">Satın Al</button></div>
<div class="pack"><h2>Elmas</h2><div class="price">🪙 8.000</div><p>89,99 €</p><button data-base-label='Satın Al' class="btn">Satın Al</button></div>
...
def settings_page():
    ...
    <div class='grid'>
      ...
      <div class='item'><h3 data-i18n='rules'>📜 Kurallar</h3><p>Saygılı oyun, hile yasak, uygunsuz davranış yasak.</p></div>
...
@app.route("/premium")
def premium_page():
    content = """<div class='grid'><div class='item'><h2>💎 Premium Üyelik</h2><p>Premium üyelik sistemi yakında aktif olacak.</p><p>Özel rozet, çerçeve, sandık bonusu ve turnuva avantajları içerecek.</p></div></div>"""
    return montenoir_page("💎 Premium Üyelik", content)



@app.route("/coming-soon/<game>")
def coming_soon_game(game):
    safe_game = str(game).replace("<", "").replace(">", "")
    content = f"""<div class='grid'><div class='item'><h2>🎮 {safe_game}</h2><p>Bu oyun yakında MONTENOIR VIP'e eklenecek.</p><a class='btn' href='/'>Ana sayfa</a></div></div>"""
    return montenoir_page(f"🎮 {safe_game}", content)
