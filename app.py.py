...
.centerUI{
  position:absolute;z-index:10;left:50%;top:52%;transform:translate(-50%,-50%);
...
@media(max-width:1100px){.nav{display:none}.userBlock{display:none}.topbar{justify-content:space-between}.brand{width:auto;font-size:22px}.bottomCards{display:none}.home{background-size:cover;background-position:center top}.centerUI{top:54%}}
