...
# === CLEAN MONTENOIR ROUTES ===
@app.route("/", endpoint="montenoir_home_unique")
def montenoir_home_unique():
    return render_template("index.html")

@app.route("/metropoly", endpoint="metropoly_unique")
@app.route("/monopoly", endpoint="monopoly_alias_unique")
def metropoly_unique():
