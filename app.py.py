...
<body><div class="stage"><div class="cards"><div class="card c1"><b>A</b><span>♠</span></div><div class="card c2"><b>K</b><span>♥</span></div><div class="card c3"><b>Q</b><span>♦</span></div><div class="card c4"><b>J</b><span>♣</span></div></div><h1 class="logo">ROYAL VIP</h1><div class="subtitle">Casino · Oyun · Tarot</div><main class="table"><div class="btnRow"><button class="royalBtn" onclick="toggleGames()">🎮 OYUNLAR</button><button class="royalBtn" onclick="location.href='/tarot'">🔮 TAROT & RİTÜEL</button></div><section id="gamesPanel" class="menuPanel"><div class="gameGrid"><a class="gameItem" href="/codenames">👑 Codenames VIP</a><a class="gameItem soon" href="/coming-soon/Poker">♠️ Poker</a><a class="gameItem soon" href="/coming-soon/Tavla">🎲 Tavla</a><a class="gameItem soon" href="/coming-soon/Okey">🀄 Okey</a><a class="gameItem soon" href="/coming-soon/101">💎 101</a><a class="gameItem soon" href="/coming-soon/Monopoly">🏙️ Monopoly</a><a class="gameItem soon" href="/coming-soon/Ludo">🔴 Ludo</a><a class="gameItem soon" href="/coming-soon/Bowling">🎳 Bowling</a></div><div class="note">Şimdilik Codenames VIP oynanabilir. Diğer oyunlar tek tek eklenecek.</div></section></main><div class="footer">Siyah & doré lüks oyun salonu</div></div><script>function toggleGames(){document.getElementById('gamesPanel').classList.toggle('show')}</script></body></html>
'''

COMING_SOON_HTML = r'''
<!DOCTYPE html><html lang="tr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Yakında</title><style>body{margin:0;min-height:100vh;background:radial-gradient(circle,#2c2108,#000 65%);color:#f6d777;font-family:Arial;text-align:center;display:flex;align-items:center;justify-content:center}.box{border:2px solid #d4af37;border-radius:28px;padding:45px;max-width:620px;background:rgba(0,0,0,.72);box-shadow:0 0 45px rgba(212,175,55,.45)}h1{font-family:Georgia,serif;font-size:48px}a{display:inline-block;margin-top:18px;padding:14px 20px;border-radius:14px;background:#111;border:1px solid #d4af37;color:#f6d777;text-decoration:none;font-weight:bold}</style></head><body><div class="box"><h1>👑 {{ game }}</h1><h2>Yakında geliyor</h2><p>Bu oyun daha sonra kurallarına göre ayrı ayrı kodlanacak.</p><a href="/">⬅ Ana sayfaya dön</a></div></body></html>
'''
