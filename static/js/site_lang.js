...
const COMMON_I18N = {
  ...
  en: { back_home: '← Back to home', games_title: '🎮 MONTENOIR GAMES', coming_soon: 'Coming soon.', login_title: '👤 Login', register_title: '📝 Register',
    ...
    premium_title: '💎 Premium Membership', premium_desc: 'The premium membership system will be active soon.', kasa_title: '🪙 Montenoir Cashier', kasa_desc: 'Chip packs and the payment system will be here soon.', kasa_balance_label: 'Current balance', kasa_buy_btn: 'Buy (demo)', kasa_login_required: 'Log in to buy chips.', tournaments_title: '🏆 Tournaments', tournaments_desc: 'Weekly Codenames Tournament — Entry: 100 chips — Prize: 5000 chips.', friends_title: '👥 Friends', friends_desc: 'Adding friends, private messages and online status coming soon.', rules_title: '📜 Game Rules', rules_desc: 'Respectful play, cheating forbidden, inappropriate behavior forbidden.', chests_title: '🎁 Chest System', chests_desc: 'Bronze, Silver, Gold and Diamond chests coming soon.', profile_shop_title: '🎨 Profile Customization', profile_shop_desc: 'Gold frame, diamond frame, baroque frame, name colors and animated profile coming soon.', ai_tarot_title: '🤖 AI Tarot Premium', ai_tarot_desc: 'Premium reading: 1500 chips.' , ai_tarot_desc2: 'Personalized reading with birth date, question and photo coming soon.' ,
    profile_title: '👤 My Profile', not_logged_in_msg: 'You are not logged in.', go_to_login_btn: 'Log in', current_avatar_label: 'Current avatar', choose_new_avatar: 'Choose a new photo', save_avatar_btn: 'Save avatar', delete_avatar_btn: 'Delete avatar', avatar_help: 'PNG, JPG or WebP, reasonable size.', avatar_saved_msg: '✅ Avatar updated!', avatar_deleted_msg: '🗑️ Avatar deleted.', account_chips: 'Chips', account_level: 'Level', account_xp: 'XP' },
  ...
  de: { back_home: '← Zurück zur Startseite', games_title: '🎮 MONTENOIR SPIELE', coming_soon: 'Demnächst verfügbar.', login_title: '👤 Anmelden', register_title: '📝 Registrierung',
    ...
    premium_title: '💎 Premium-Mitgliedschaft', premium_desc: 'Das Premium-Mitgliedschaftssystem wird bald aktiv sein.', kasa_title: '🪙 Montenoir Kasse', kasa_desc: 'Chip-Pakete und das Zahlungssystem werden bald hier sein.', kasa_balance_label: 'Aktuelles Guthaben', kasa_buy_btn: 'Kaufen (Demo)', kasa_login_required: 'Melde dich an, um Chips zu kaufen.', tournaments_title: '🏆 Turniere', tournaments_desc: 'Wöchentliches Codenames-Turnier — Eintritt: 100 Chips — Preis: 5000 Chips.', friends_title: '👥 Freunde', friends_desc: 'Freunde hinzufügen, private Nachrichten und Online-Status demnächst verfügbar.', rules_title: '📜 Spielregeln', rules_desc: 'Respektvolles Spiel, Betrug verboten, unangemessenes Verhalten verboten.', chests_title: '🎁 Truhensystem', chests_desc: 'Bronze-, Silber-, Gold- und Diamant-Truhen demnächst verfügbar.', profile_shop_title: '🎨 Profilanpassung', profile_shop_desc: 'Goldrahmen, Diamantrahmen, Barockrahmen, Namensfarben und animiertes Profil demnächst verfügbar.', ai_tarot_title: '🤖 KI Tarot Premium', ai_tarot_desc: 'Premium-Lesung: 1500 Chips.' , ai_tarot_desc2: 'Personalisierte Lesung mit Geburtsdatum, Frage und Foto demnächst verfügbar.' ,
    profile_title: '👤 Mein Profil', not_logged_in_msg: 'Du bist nicht angemeldet.', go_to_login_btn: 'Anmelden', current_avatar_label: 'Aktueller Avatar', choose_new_avatar: 'Neues Foto wählen', save_avatar_btn: 'Avatar speichern', delete_avatar_btn: 'Avatar löschen', avatar_help: 'PNG, JPG oder WebP, angemessene Größe.', avatar_saved_msg: '✅ Avatar aktualisiert!', avatar_deleted_msg: '🗑️ Avatar gelöscht.', account_chips: 'Chips', account_level: 'Level', account_xp: 'XP' },
  ...
  ar: { back_home: '→ العودة للرئيسية', games_title: '🎮 ألعاب مونتينوار', coming_soon: 'قريبًا.', login_title: '👤 تسجيل الدخول', register_title: '📝 تسجيل',
    ...
    premium_title: '💎 عضوية بريميوم', premium_desc: 'سيتم تفعيل نظام العضوية المميزة قريبًا.', kasa_title: '🪙 خزينة Montenoir', kasa_desc: 'ستكون حزم الرقاقات ونظام الدفع هنا قريبًا.', kasa_balance_label: 'الرصيد الحالي', kasa_buy_btn: 'شراء (تجريبي)', kasa_login_required: 'سجّل الدخول لشراء الرقاقات.', tournaments_title: '🏆 البطولات', tournaments_desc: 'بطولة Codenames الأسبوعية — الدخول: 100 رقاقة — الجائزة: 5000 رقاقة.', friends_title: '👥 الأصدقاء', friends_desc: 'إضافة الأصدقاء والرسائل الخاصة وحالة الاتصال قريبًا.', rules_title: '📜 قواعد اللعبة', rules_desc: 'لعب محترم، الغش ممنوع، السلوك غير اللائق ممنوع.', chests_title: '🎁 نظام الصناديق', chests_desc: 'صناديق برونزية وفضية وذهبية وماسية قريبًا.', profile_shop_title: '🎨 تخصيص الملف الشخصي', profile_shop_desc: 'إطار ذهبي وإطار ماسي وإطار باروكي وألوان الاسم والملف الشخصي المتحرك قريبًا.', ai_tarot_title: '🤖 تارو الذكاء الاصطناعي المميز', ai_tarot_desc: 'قراءة مميزة: 1500 رقاقة.' , ai_tarot_desc2: 'قراءة مخصصة مع تاريخ الميلاد والسؤال والصورة قريبًا.' ,
    profile_title: '👤 ملفي الشخصي', not_logged_in_msg: 'لم تقم بتسجيل الدخول.', go_to_login_btn: 'تسجيل الدخول', current_avatar_label: 'الصورة الرمزية الحالية', choose_new_avatar: 'اختر صورة جديدة', save_avatar_btn: 'حفظ الصورة الرمزية', delete_avatar_btn: 'حذف الصورة الرمزية', avatar_help: 'PNG أو JPG أو WebP، بحجم معقول.', avatar_saved_msg: '✅ تم تحديث الصورة الرمزية!', avatar_deleted_msg: '🗑️ تم حذف الصورة الرمزية.', account_chips: 'الرقاقات', account_level: 'المستوى', account_xp: 'XP' },
  pt: { back_home: '← Voltar ao início', games_title: '🎮 JOGOS MONTENOIR', coming_soon: 'Em breve.', login_title: '👤 Entrar', register_title: '📝 Registrar',
    ...
    premium_title: '💎 Assinatura Premium', premium_desc: 'O sistema de assinatura premium estará ativo em breve.', kasa_title: '🪙 Caixa Montenoir', kasa_desc: 'Os pacotes de fichas e o sistema de pagamento estarão aqui em breve.', kasa_balance_label: 'Saldo atual', kasa_buy_btn: 'Comprar (demo)', kasa_login_required: 'Faça login para comprar fichas.', tournaments_title: '🏆 Torneios', tournaments_desc: 'Torneio Semanal de Codenames — Entrada: 100 fichas — Prêmio: 5000 fichas.', friends_title: '👥 Amigos', friends_desc: 'Adicionar amigos, mensagens privadas e status online em breve.', rules_title: '📜 Regras do jogo', rules_desc: 'Jogo respeitoso, trapaça proibida, comportamento inadequado proibido.', chests_title: '🎁 Sistema de baús', chests_desc: 'Baús de Bronze, Prata, Ouro e Diamante em breve.', profile_shop_title: '🎨 Personalização de perfil', profile_shop_desc: 'Moldura dourada, moldura de diamante, moldura barroca, cores de nome e perfil animado em breve.', ai_tarot_title: '🤖 IA Tarô Premium', ai_tarot_desc: 'Leitura premium: 1500 fichas.' , ai_tarot_desc2: 'Leitura personalizada com data de nascimento, pergunta e foto em breve.' ,
    profile_title: '👤 Meu Perfil', not_logged_in_msg: 'Você não está conectado.', go_to_login_btn: 'Entrar', current_avatar_label: 'Avatar atual', choose_new_avatar: 'Escolher nova foto', save_avatar_btn: 'Salvar avatar', delete_avatar_btn: 'Excluir avatar', avatar_help: 'PNG, JPG ou WebP, tamanho razoável.', avatar_saved_msg: '✅ Avatar atualizado!', avatar_deleted_msg: '🗑️ Avatar excluído.', account_chips: 'Fichas', account_level: 'Nível', account_xp: 'XP' },
  ...
  tr: { back_home: '← Ana sayfaya dön', games_title: '🎮 MONTENOIR OYUNLARI', coming_soon: 'Yakında.', login_title: '👤 Giriş Yap', register_title: '📝 Kayıt Ol',
    ...
    premium_title: '💎 Premium Üyelik', premium_desc: 'Premium üyelik sistemi yakında aktif olacak.', kasa_title: '🪙 Montenoir Kasası', kasa_desc: 'Jeton paketleri ve ödeme sistemi burada olacak.', kasa_balance_label: 'Güncel bakiye', kasa_buy_btn: 'Satın al (demo)', kasa_login_required: 'Jeton satın almak için giriş yap.', tournaments_title: '🏆 Turnuvalar', tournaments_desc: 'Haftalık Codenames Turnuvası — Giriş: 100 jeton — Ödül: 5000 jeton.', friends_title: '👥 Arkadaşlar', friends_desc: 'Arkadaş ekleme, özel mesaj ve çevrimiçi durumu yakında.', rules_title: '📜 Oyun Kuralları', rules_desc: 'Saygılı oyun, hile yasak, uygunsuz davranış yasak.', chests_title: '🎁 Sandık Sistemi', chests_desc: 'Bronz, Gümüş, Altın ve Elmas sandıklar yakında.', profile_shop_title: '🎨 Profil Özelleştirme', profile_shop_desc: 'Altın çerçeve, elmas çerçeve, barok çerçeve, isim renkleri ve animasyonlu profil yakında.', ai_tarot_title: '🤖 AI Tarot Premium', ai_tarot_desc: 'Premium yorum: 1500 jeton.' , ai_tarot_desc2: 'Doğum tarihi, soru ve fotoğraf ile kişiselleştirilmiş yorum yakında.' ,
    profile_title: '👤 Profilim', not_logged_in_msg: 'Giriş yapmadın.', go_to_login_btn: 'Giriş Yap', current_avatar_label: 'Mevcut avatar', choose_new_avatar: 'Yeni fotoğraf seç', save_avatar_btn: 'Avatarı Kaydet', delete_avatar_btn: 'Avatarı Sil', avatar_help: 'PNG, JPG veya WebP, makul boyut.', avatar_saved_msg: '✅ Avatar güncellendi!', avatar_deleted_msg: '🗑️ Avatar silindi.', account_chips: 'Jeton', account_level: 'Seviye', account_xp: 'XP' },
  ja: { back_home: '← ホームに戻る', games_title: '🎮 MONTENOIR ゲーム', coming_soon: '近日公開。', login_title: '👤 ログイン', register_title: '📝 登録',
    ...
    premium_title: '💎 プレミアム会員', premium_desc: 'プレミアム会員制度は近日中に有効になります。', kasa_title: '🪙 Montenoirキャッシャー', kasa_desc: 'チップパックと決済システムは近日公開予定です。', kasa_balance_label: '現在の残高', kasa_buy_btn: '購入（デモ）', kasa_login_required: 'チップを購入するにはログインしてください。', tournaments_title: '🏆 トーナメント', tournaments_desc: '週間コードネームトーナメント — 参加費：チップ100枚 — 賞品：チップ5000枚。', friends_title: '👥 フレンド', friends_desc: 'フレンド追加、プライベートメッセージ、オンライン状態は近日公開。', rules_title: '📜 ゲームルール', rules_desc: '敬意ある対戦、不正行為禁止、不適切な行動禁止。', chests_title: '🎁 チェストシステム', chests_desc: 'ブロンズ、シルバー、ゴールド、ダイヤモンドチェストは近日公開。', profile_shop_title: '🎨 プロフィールカスタマイズ', profile_shop_desc: 'ゴールドフレーム、ダイヤモンドフレーム、バロックフレーム、名前の色、アニメーションプロフィールは近日公開。', ai_tarot_title: '🤖 AIタロットプレミアム', ai_tarot_desc: 'プレミアム鑑定：チップ1500枚。' , ai_tarot_desc2: '生年月日、質問、写真によるパーソナライズされた鑑定は近日公開。' ,
    profile_title: '👤 マイプロフィール', not_logged_in_msg: 'ログインしていません。', go_to_login_btn: 'ログイン', current_avatar_label: '現在のアバター', choose_new_avatar: '新しい写真を選択', save_avatar_btn: 'アバターを保存', delete_avatar_btn: 'アバターを削除', avatar_help: 'PNG、JPG、またはWebP、適度なサイズ。', avatar_saved_msg: '✅ アバターを更新しました！', avatar_deleted_msg: '🗑️ アバターを削除しました。', account_chips: 'チップ', account_level: 'レベル', account_xp: 'XP' },
  zh: { back_home: '← 返回首页', games_title: '🎮 MONTENOIR 游戏', coming_soon: '即将推出。', login_title: '👤 登录', register_title: '📝 注册',
    ...
    premium_title: '💎 高级会员', premium_desc: '高级会员系统即将上线。', kasa_title: '🪙 Montenoir收银台', kasa_desc: '筹码套餐和支付系统即将上线。', kasa_balance_label: '当前余额', kasa_buy_btn: '购买（演示）', kasa_login_required: '登录后购买筹码。', tournaments_title: '🏆 锦标赛', tournaments_desc: '每周codenames锦标赛 — 入场：100筹码 — 奖励：5000筹码。', friends_title: '👥 好友', friends_desc: '添加好友、私信和在线状态即将推出。', rules_title: '📜 游戏规则', rules_desc: '尊重比赛，禁止作弊，禁止不当行为。', chests_title: '🎁 宝箱系统', chests_desc: '青铜、白银、黄金和钻石宝箱即将推出。', profile_shop_title: '🎨 个人资料自定义', profile_shop_desc: '金色边框、钻石边框、巴洛克边框、名称颜色和动态资料即将推出。', ai_tarot_title: '🤖 AI塔罗高级版', ai_tarot_desc: '高级解读：1500筹码。' , ai_tarot_desc2: '根据出生日期、问题和照片提供的个性化解读即将推出。' ,
    profile_title: '👤 我的资料', not_logged_in_msg: '您尚未登录。', go_to_login_btn: '登录', current_avatar_label: '当前头像', choose_new_avatar: '选择新照片', save_avatar_btn: '保存头像', delete_avatar_btn: '删除头像', avatar_help: 'PNG、JPG 或 WebP，大小适中。', avatar_saved_msg: '✅ 头像已更新！', avatar_deleted_msg: '🗑️ 头像已删除。', account_chips: '筹码', account_level: '等级', account_xp: '经验值' },
  ko: { back_home: '← 홈으로', games_title: '🎮 MONTENOIR 게임', coming_soon: '곧 제공됩니다.', login_title: '👤 로그인', register_title: '📝 등록',
    ...
    premium_title: '💎 프리미엄 멤버십', premium_desc: '프리미엄 멤버십 시스템이 곧 활성화됩니다.', kasa_title: '🪙 Montenoir 캐셔', kasa_desc: '칩 패키지와 결제 시스템이 곧 제공됩니다.', kasa_balance_label: '현재 잔액', kasa_buy_btn: '구매 (데모)', kasa_login_required: '칩을 구매하려면 로그인하세요.', tournaments_title: '🏆 토너먼트', tournaments_desc: '주간 코드네임 토너먼트 — 참가비: 칩 100개 — 상금: 칩 5000개.', friends_title: '👥 친구', friends_desc: '친구 추가, 개인 메시지 및 온라인 상태가 곧 제공됩니다.', rules_title: '📜 게임 규칙', rules_desc: '존중하는 플레이, 부정행위 금지, 부적절한 행동 금지.', chests_title: '🎁 상자 시스템', chests_desc: '브론즈, 실버, 골드, 다이아몬드 상자가 곧 제공됩니다.', profile_shop_title: '🎨 프로필 커스터마이징', profile_shop_desc: '골드 프레임, 다이아몬드 프레임, 바로크 프레임, 이름 색상 및 애니메이션 프로필이 곧 제공됩니다.', ai_tarot_title: '🤖 AI 타로 프리미엄', ai_tarot_desc: '프리미엄 리딩: 칩 1500개.' , ai_tarot_desc2: '생년월일, 질문, 사진을 활용한 맞춤형 리딩이 곧 제공됩니다.' ,
    profile_title: '👤 내 프로필', not_logged_in_msg: '로그인하지 않았습니다.', go_to_login_btn: '로그인', current_avatar_label: '현재 아바타', choose_new_avatar: '새 사진 선택', save_avatar_btn: '아바타 저장', delete_avatar_btn: '아바타 삭제', avatar_help: 'PNG, JPG 또는 WebP, 적당한 크기.', avatar_saved_msg: '✅ 아바타가 업데이트되었습니다!', avatar_deleted_msg: '🗑️ 아바타가 삭제되었습니다.', account_chips: '칩', account_level: '레벨', account_xp: '경험치' }
};
...
,
  "Önce giriş yap.": { fr:'Connecte-toi d\'abord.', en:'Please log in first.', es:'Inicia sesión primero.', de:'Bitte melde dich zuerst an.', it:'Accedi prima.', nl:'Log eerst in.', ru:'Сначала войдите.', ar:'يرجى تسجيل الدخول أولاً.', pt:'Faça login primeiro.', pl:'Najpierw się zaloguj.', tr:'Önce giriş yap.', ja:'最初にログインしてください。', zh:'请先登录。', ko:'먼저 로그인하세요.' },
  "Avatar dosyası seçilmedi.": { fr:'Aucun fichier avatar sélectionné.', en:'No avatar file selected.', es:'No se seleccionó ningún archivo de avatar.', de:'Keine Avatar-Datei ausgewählt.', it:'Nessun file avatar selezionato.', nl:'Geen avatarbestand geselecteerd.', ru:'Файл аватара не выбран.', ar:'لم يتم اختيار ملف الصورة الرمزية.', pt:'Nenhum arquivo de avatar selecionado.', pl:'Nie wybrano pliku awatara.', tr:'Avatar dosyası seçilmedi.', ja:'アバターファイルが選択されていません。', zh:'未选择头像文件。', ko:'아바타 파일이 선택되지 않았습니다.' },
  "Sadece JPG, PNG veya WEBP yüklenebilir.": { fr:'Seuls les fichiers JPG, PNG ou WEBP sont acceptés.', en:'Only JPG, PNG or WEBP can be uploaded.', es:'Solo se pueden subir archivos JPG, PNG o WEBP.', de:'Nur JPG, PNG oder WEBP können hochgeladen werden.', it:'È possibile caricare solo JPG, PNG o WEBP.', nl:'Alleen JPG, PNG of WEBP kan worden geüpload.', ru:'Можно загружать только JPG, PNG или WEBP.', ar:'يمكن رفع ملفات JPG أو PNG أو WEBP فقط.', pt:'Apenas JPG, PNG ou WEBP podem ser enviados.', pl:'Można przesyłać tylko pliki JPG, PNG lub WEBP.', tr:'Sadece JPG, PNG veya WEBP yüklenebilir.', ja:'JPG、PNG、WEBPのみアップロードできます。', zh:'仅可上传 JPG、PNG 或 WEBP 文件。', ko:'JPG, PNG 또는 WEBP만 업로드할 수 있습니다.' }
};
