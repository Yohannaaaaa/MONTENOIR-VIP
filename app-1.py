...
@app.route("/uyelik")
def register_page():
    return render_template_string("""<html><head><meta charset="UTF-8"><title>Üyelik</title></head><body style="margin:0;background:#050505;color:#d4af37;font-family:Arial,sans-serif;text-align:center;padding-top:120px;"><h1>📝 Üyelik</h1><h2>MONTENOIR VIP</h2><p>Inscription bientôt disponible.</p><br><a href="/" style="color:white;text-decoration:none;">← Retour accueil</a></body></html>""")

@app.route("/login")
@app.route("/connexion")
def login_page():
    return render_template_string("""<html><head><meta charset="UTF-8"><title>Connexion</title></head><body style="margin:0;background:#050505;color:#d4af37;font-family:Arial,sans-serif;text-align:center;padding-top:120px;"><h1>👤 Connexion</h1><h2>MONTENOIR VIP</h2><p>Connexion bientôt disponible.</p><br><a href="/" style="color:white;text-decoration:none;">← Retour accueil</a></body></html>""")

@app.route("/premium")
def premium_page():
    return render_template_string("""<html><head><meta charset="UTF-8"><title>Premium</title></head><body style="margin:0;background:#050505;color:#d4af37;font-family:Arial,sans-serif;text-align:center;padding-top:120px;"><h1>💎 Premium</h1><h2>MONTENOIR VIP</h2><p>Espace Premium bientôt disponible.</p><br><a href="/" style="color:white;text-decoration:none;">← Retour accueil</a></body></html>""")
